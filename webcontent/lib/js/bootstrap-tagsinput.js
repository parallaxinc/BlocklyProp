(function($) {
    ...
    TagsInput.prototype = {
        ...
        add: function(item, dontPushVal) {
            ...
            // add a tag element
            var tagText = '<span class="tag ' + htmlEncode(tagClass) + '">' + htmlEncode(itemText);
            if (!self.options.readonly) {
                tagText += '<span data-role="remove"></span>';
            }
            tagText += '</span>';
            var $tag = $(tagText);
            $tag.data('item', item);
        ...
        build: function(options) {
            ...
            if (typeahead.source && $.fn.typeahead && !self.options.readonly) {
