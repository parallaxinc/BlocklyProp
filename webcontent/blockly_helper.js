...
function backup_blocks() {
    if ('localStorage' in window) {
        ...
        window.localStorage.setItem('spin', Blockly.Xml.domToText(xml));
    }
}
...
function restore_blocks() {
    if ('localStorage' in window && window.localStorage.spin) {
        var xml = Blockly.Xml.textToDom(window.localStorage.spin);
