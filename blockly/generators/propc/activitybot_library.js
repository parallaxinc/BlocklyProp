...
Blockly.propc.activitybot_ramp_step_toward = function() {
    var left_rampstep = this.getTitleValue( 'LEFT_RAMPSTEP' );
    var right_rampstep = this.getTitleValue( 'RIGHT_RAMPSTEP' );
