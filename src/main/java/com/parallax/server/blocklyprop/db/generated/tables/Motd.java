...
public class Motd extends TableImpl<MotdRecord> {
	...
	private static final long serialVersionUID = -704589340;
	 ...
	 */
	public final TableField<MotdRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>blocklyprop.motd.message</code>.
	 */
	public final TableField<MotdRecord, String> MESSAGE = createField("message", org.jooq.impl.SQLDataType.VARCHAR.length(4000).nullable(false), this, "");

	/**
	 * The column <code>blocklyprop.motd.enable_date</code>.
	 */
	public final TableField<MotdRecord, Timestamp> ENABLE_DATE = createField("enable_date", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

	/**
	 * The column <code>blocklyprop.motd.disable_date</code>.
	 */
	public final TableField<MotdRecord, Timestamp> DISABLE_DATE = createField("disable_date", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

	/**
	 * The column <code>blocklyprop.motd.create_date</code>.
	 */
	public final TableField<MotdRecord, Timestamp> CREATE_DATE = createField("create_date", org.jooq.impl.SQLDataType.TIMESTAMP.defaulted(true), this, "");
	 ...
	 */
	@Override
	public Identity<MotdRecord, Integer> getIdentity() {
