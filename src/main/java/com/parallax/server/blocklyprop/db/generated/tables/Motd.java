...
public class Motd extends TableImpl<MotdRecord> {
	...
	private static final long serialVersionUID = -745623628;
	 ...
	 */
	public final TableField<MotdRecord, String> MESSAGE_TEXT = createField("message_text", org.jooq.impl.SQLDataType.VARCHAR.length(250).nullable(false), this, "");

	/**
	 * The column <code>blocklyprop.motd.message_html</code>.
	 */
	public final TableField<MotdRecord, String> MESSAGE_HTML = createField("message_html", org.jooq.impl.SQLDataType.VARCHAR.length(250).defaulted(true), this, "");

	/**
	 * The column <code>blocklyprop.motd.notes</code>.
	 */
	public final TableField<MotdRecord, String> NOTES = createField("notes", org.jooq.impl.SQLDataType.VARCHAR.length(250).defaulted(true), this, "");
	 ...
	 */
	public final TableField<MotdRecord, Timestamp> ENABLE_DATETIME = createField("enable_datetime", org.jooq.impl.SQLDataType.TIMESTAMP.defaulted(true), this, "");

	/**
	 * The column <code>blocklyprop.motd.disable_datetime</code>.
	 */
	public final TableField<MotdRecord, Timestamp> DISABLE_DATETIME = createField("disable_datetime", org.jooq.impl.SQLDataType.TIMESTAMP.defaulted(true), this, "");
