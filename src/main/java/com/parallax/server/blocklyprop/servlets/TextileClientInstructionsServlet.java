 ...
 */
@Singleton
public class TextileClientInstructionsServlet extends HttpServlet {

    private final TextileReader textileFileReader = new TextileReader();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String html = textileFileReader.readFile("client-instructions", ServletUtils.getLocale(req), req.isSecure());
