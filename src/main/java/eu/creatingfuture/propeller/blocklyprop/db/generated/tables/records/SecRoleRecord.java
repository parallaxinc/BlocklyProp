...
public class SecRoleRecord extends UpdatableRecordImpl<SecRoleRecord> implements Record2<Long, String> {

	private static final long serialVersionUID = 1122311679;
	 ...
	 */
	@Override
	public SecRoleRecord value2(String value) {
		setName(value);
		return this;
	}
	 ...
	 */
	@Override
	public SecRoleRecord values(Long value1, String value2) {
		value1(value1);
		value2(value2);
		return this;
	}
	 ...
	 */
	public SecRoleRecord(Long id, String name) {
		super(SecRole.SEC_ROLE);
