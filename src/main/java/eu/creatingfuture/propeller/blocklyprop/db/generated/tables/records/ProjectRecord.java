...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record10<Integer, Integer, String, String, String, Integer, Boolean, Boolean, GregorianCalendar, GregorianCalendar> {

	private static final long serialVersionUID = 2066058626;
	 ...
	 */
	@Override
	public Row10<Integer, Integer, String, String, String, Integer, Boolean, Boolean, GregorianCalendar, GregorianCalendar> fieldsRow() {
	 ...
	 */
	@Override
	public Row10<Integer, Integer, String, String, String, Integer, Boolean, Boolean, GregorianCalendar, GregorianCalendar> valuesRow() {
	 ...
	 */
	@Override
	public ProjectRecord values(Integer value1, Integer value2, String value3, String value4, String value5, Integer value6, Boolean value7, Boolean value8, GregorianCalendar value9, GregorianCalendar value10) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ProjectRecord(Integer id, Integer idUser, String name, String description, String code, Integer type, Boolean private_, Boolean shared, GregorianCalendar created, GregorianCalendar modified) {
		super(Project.PROJECT);
