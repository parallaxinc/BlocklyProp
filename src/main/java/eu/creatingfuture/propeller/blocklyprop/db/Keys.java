...
import eu.creatingfuture.propeller.blocklyprop.db.tables.records.ProjectTagRecord;
import eu.creatingfuture.propeller.blocklyprop.db.tables.records.TagRecord;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		...
		public static final ForeignKey<ProjectTagRecord, ProjectRecord> PROJECT_TAG_PROJECT = createForeignKey(eu.creatingfuture.propeller.blocklyprop.db.Keys.KEY_PROJECT_PRIMARY, ProjectTag.PROJECT_TAG, ProjectTag.PROJECT_TAG.ID_PROJECT);
		public static final ForeignKey<ProjectTagRecord, TagRecord> PROJECT_TAG_TAG = createForeignKey(eu.creatingfuture.propeller.blocklyprop.db.Keys.KEY_TAG_PRIMARY, ProjectTag.PROJECT_TAG, ProjectTag.PROJECT_TAG.ID_TAG);
	}
}
