                ...
                <td>
                    <table>
                        <tr id="tabRow" height="1em">
                            ...
                            <td class="tabmin">&nbsp;</td-->
                            <td id="tab_propc" class="taboff" onclick="tabClick(this.id)">Propeller&nbsp;C</td>
                            <td class="tabmin">&nbsp;</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="memmory-model">Memory model</label>
                            <select class="form-control" id="memory-model">
                            </select>
                        </div>
