...
<html>
    ...
    <body onload="blocklyReady();">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="clients">
                            ...
                            <!-- THESE ARE ALSO COPIED ABOVE - CHANGES HERE NEED TO BE MIRRORED ABOVE -->
                            <!-- MacOS client -->
                            <div class="client-instructions MacOS">
        ...
        <%--                            <!-- BPC/BPL version warning -->
                            <div class="container-fluid" style="background:#FAE6A4; color:#8a6d3b; padding:10px; display: none;" id="client-warning">
                                <div class="row">
                                    <div class="col-sm-11" id="client-warning-text" align="center"></div>
                                    <div class="col-sm-1" align="right"><button type="button" class="close" onclick="closeClientWarning();">&times;</button></div>
                                </div>
                                
                                <div class="row" align="center">
                                    <!-- THESE ARE ALSO COPIED BELOW - CHANGES HERE NEED TO BE MIRRORED ABOVE -->
                                    <!-- MacOS client -->
                                    <div class="client-instructions MacOS">
                                        <h4><span class="keyed-lang-string" key="clientdownload_download_installer"></span></h4>
                                    </div>
