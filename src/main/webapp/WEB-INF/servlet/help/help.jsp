            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="panel panel-default text-center">
                            <div class="panel-heading">
                                <img alt="(Activity Bot and Flip Module)" title="(Activity Bot and Flip Module)" border="0" src="https://s3.amazonaws.com/aws-blockly-cdn.parallax.com/demo/0.101/35/images/products/ABandFLIP.png" style="max-width:100%;height:auto;"/>
                            </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading text-center">
                                <img alt="(Scribbler 3)" title="(Scribbler 3)" border="0" src="https://s3.amazonaws.com/aws-blockly-cdn.parallax.com/demo/0.101/35/images/products/S3.png" style="max-width:100%;height:auto;"/>
                            </div>
                            <div class="panel-body text-center">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="panel panel-default text-center">
                            <div class="panel-heading">
                                <img alt="(Badge WX)" title="(Badge WX)" border="0" src="https://s3.amazonaws.com/aws-blockly-cdn.parallax.com/demo/0.101/35/images/products/BadgeWX.png" style="max-width:100%;height:auto;"/>
                            </div>
                            <div class="panel-body text-center">
