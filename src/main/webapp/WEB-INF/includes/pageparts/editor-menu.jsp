        ...
        <div style="display:inline;">
            ...
            <div style="width:100%; padding-bottom: 5px;">
                ...
                <div style="display:inline; clear:right; float:right;  padding-right: 10px;" align="right">
                    ...
                    <c:if test="${param.editor_lang == 'c'}">
                        <a class="btn-view-code" id="btn-view-propc" style="display:inline;" href="#" onclick="tabClick('tab_propc')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"><path d="M0.5,9 C4,3.5 10,3.5 13.5,9 C10,14.5 4,14.5 0.5,9 M0.5,9 C4,5.5 10,5.5 13.5,9" style="stroke:#000;stroke-width:1.5;fill:none;"/><circle cx="7" cy="8.5" r="2.75" style="stroke:#000;stroke-width:1.5;fill:none;"></circle><circle cx="7" cy="8.5" r=".5" style="stroke:#000;stroke-width:1.5;fill:#000;"></circle></svg> Code</a>
                    </c:if>
                    <c:if test="${param.editor_lang == 'spin'}">
                        <a class="btn-view-code" id="btn-view-spin" style="display:inline;" href="#" onclick="tabClick('tab_spin')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"><path d="M0.5,9 C4,3.5 10,3.5 13.5,9 C10,14.5 4,14.5 0.5,9 M0.5,9 C4,5.5 10,5.5 13.5,9" style="stroke:#000;stroke-width:1.5;fill:none;"/><circle cx="7" cy="8.5" r="2.75" style="stroke:#000;stroke-width:1.5;fill:none;"></circle><circle cx="7" cy="8.5" r=".5" style="stroke:#000;stroke-width:1.5;fill:#000;"></circle></svg> Code</a>
                    </c:if>
                    <a class="btn-view-blocks" id="btn-view-blocks" style="display:none;" href="#" onclick="tabClick('tab_blocks')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"><path d="M0.5,9 C4,3.5 10,3.5 13.5,9 C10,14.5 4,14.5 0.5,9 M0.5,9 C4,5.5 10,5.5 13.5,9" style="stroke:#fff;stroke-width:1.5;fill:none;"/><circle cx="7" cy="8.5" r="2.75" style="stroke:#fff;stroke-width:1.5;fill:none;"></circle><circle cx="7" cy="8.5" r=".5" style="stroke:#fff;stroke-width:1.5;fill:#fff;"></circle></svg> Blocks</a>                    
