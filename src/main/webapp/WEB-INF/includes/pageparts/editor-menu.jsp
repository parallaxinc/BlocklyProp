        ...
        <div style="display:inline;">
            ...
            <div style="width:100%; padding-bottom: 5px;">
                ...
                <div style="display:inline; clear:right; float:right;  padding-right: 10px;" align="right">
                    ...
                    <c:if test="${param.editor_lang == 'c'}">
                        <a class="btn-view-code" id="btn-view-propc" style="display:inline;" href="#" onclick="tabClick('tab_propc')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"><path d="M0.5,7 C4,1.5 10,1.5 13.5,7 C10,12.5 4,12.5 0.5,7 M0.5,7 C4,3.5 10,3.5 13.5,7" style="stroke:#000;stroke-width:1.5;fill:none;"/><circle cx="7" cy="6.5" r="2.75" style="stroke:#000;stroke-width:1.5;fill:none;"></circle><circle cx="7" cy="6.5" r=".5" style="stroke:#000;stroke-width:1.5;fill:#000;"></circle></svg> Code</a>
                    </c:if>
                    <c:if test="${param.editor_lang == 'spin'}">
                        <a class="btn-view-code" id="btn-view-spin" style="display:inline;" href="#" onclick="tabClick('tab_spin')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"><path d="M0.5,7 C4,1.5 10,1.5 13.5,7 C10,12.5 4,12.5 0.5,7 M0.5,7 C4,3.5 10,3.5 13.5,7" style="stroke:#000;stroke-width:1.5;fill:none;"/><circle cx="7" cy="6.5" r="2.75" style="stroke:#000;stroke-width:1.5;fill:none;"></circle><circle cx="7" cy="6.5" r=".5" style="stroke:#000;stroke-width:1.5;fill:#000;"></circle></svg> Code</a>
                    </c:if>
                    <a class="btn-view-blocks" id="btn-view-blocks" style="display:none;" href="#" onclick="tabClick('tab_blocks')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"><path d="M0.5,7 C4,1.5 10,1.5 13.5,7 C10,12.5 4,12.5 0.5,7 M0.5,7 C4,3.5 10,3.5 13.5,7" style="stroke:#fff;stroke-width:1.5;fill:none;"/><circle cx="7" cy="6.5" r="2.75" style="stroke:#fff;stroke-width:1.5;fill:none;"></circle><circle cx="7" cy="6.5" r=".5" style="stroke:#fff;stroke-width:1.5;fill:#fff;"></circle></svg> Blocks</a>                    
                    ...
                    <span class="dropdown"><button class="btn btn-sm btn-default dropdown-toggle" id="options-menu" type="button" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="14"><path d="M0.5,12.25 L11.5,12.25 11.5,13.5 0.5,13.5 Z M0.5,7.25 L11.5,7.25 11.5,8.5 0.5,8.5 Z M0.5,2.25 L11.5,2.25 11.5,3.5 0.5,3.5 Z" style="stroke:#fff;stroke-width:1;fill:#fff;"/></svg>
