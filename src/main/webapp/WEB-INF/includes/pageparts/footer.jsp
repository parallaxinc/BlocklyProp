        ...
        <div class="container">
            <div>
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<url:getUrl url="/public/changelog"/>"><fmt:message key="footer.changelog" /></a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="http://www.parallax.com" target="_blank">v0.90 Parallax &copy; 2015 - <fmt:formatDate value="${date}" pattern="yyyy" /></a></li>
                </ul>
            </div>
        </div>
    </nav>
