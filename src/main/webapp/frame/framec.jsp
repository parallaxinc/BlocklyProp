...
<!-- Add experimental="true" to categories or blocks -->
...
<!--   <category name="9" key="category_s3-simple" include="s3" colour=185>      
        <category name="10" key="category_s3-simple_simple-control" colour=205>
        ...
        <category name="11" key="category_s3-simple_simple-sensors" colour=140>
        ...
        <category name="12" key="category_s3-simple_simple-actions" colour=185>
