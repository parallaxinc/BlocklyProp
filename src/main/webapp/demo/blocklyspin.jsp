...
<html><!-- manifest=node.manifest> -->
    <head>
        ...
        <link href="<url:getUrl url="/lib/bootstrap/core/css/bootstrap.min.css"/>" rel="stylesheet">
        <link href="<url:getUrl url="/style-editor.css"/>" rel="stylesheet" type="text/css" />
    </head>
    <body>
