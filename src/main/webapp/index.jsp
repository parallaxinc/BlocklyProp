    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h2>C Project</h2>
                    <a class="editor-new-link editor-c-link editor-icon" href="<c:url value="/projectcreate.jsp?lang=PROPC"/>" data-href="<c:url value="/editor/blocklyc.jsp"/>">New</a>
                </div>

                <div class="col-md-4">
                    <h2>Spin project</h2>
                    <a class="editor-new-link editor-spin-link editor-icon" href="<c:url value="/projectcreate.jsp?lang=SPIN"/>" data-href="<c:url value="/editor/blocklyspin.jsp"/>">New</a>
                </div>
            </div>
        </div>
