...
$(document).ready(function(){user_authenticated?($(".auth-true").css("display",$(this).attr("displayas")),$(".auth-false").css("display","none")):($(".auth-false").css("display",$(this).attr("displayas")),$(".auth-true").css("display","none"));$(".url-prefix").attr("href",function(a,c){return baseUrl+c});var a=document.getElementsByTagName("img");for(l=0;l<a.length;l++)a[l].src=cdnUrl+a[l].getAttribute("data-src");$("#client-win32-link").attr("href",$("meta[name=win32client]").attr("content"));$("#client-win64-link").attr("href",
$("meta[name=win64client]").attr("content"));$("#client-mac-link").attr("href",$("meta[name=macOSclient]").attr("content"));(idProject=getURLParameter("project"))?$.get(baseUrl+"rest/shared/project/editor/"+idProject,function(a){console.log(a);projectData=a;showInfo(a);projectLoaded=!0;ready&&(setProfile(a.board),initToolbox(a.board,[]));"true"===$("#editor-full-mode")&&("s3"===projectData.board?($("#prop-btn-ram").addClass("hidden"),document.getElementById("client-available").innerHTML=document.getElementById("client-available-short").innerHTML):
($("#prop-btn-ram").removeClass("hidden"),document.getElementById("client-available").innerHTML=document.getElementById("client-available-long").innerHTML));timestampSaveTime(20,!0);setInterval(checkLastSavedTime,6E4)}).fail(function(){utils.showMessage("Unable to Access Project","The BlocklyProp Editor was unable to access the project you requested.  If you are sure the project exists, you may need to contact the project's owner and ask them to share their project before you will be able to view it.",
...
function showOS(a){$("body").removeClass("Windows").removeClass("MacOS").removeClass("Linux").removeClass("ChromeOS");$("body").addClass(a)}function showStep(a,b,c){for(var d=1;d<=c;d++)$("#"+a+d.toString()+"-btn").addClass("btn-default").removeClass("btn-primary"),$("#"+a+d.toString()).addClass("hidden");$("#"+a+b.toString()+"-btn").removeClass("btn-default").addClass("btn-primary");$("#"+a+b.toString()).removeClass("hidden")};