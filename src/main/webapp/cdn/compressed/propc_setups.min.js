...
$(document).ready(function(){user_authenticated?($(".auth-true").css("display",$(this).attr("displayas")),$(".auth-false").css("display","none")):($(".auth-false").css("display",$(this).attr("displayas")),$(".auth-true").css("display","none"));$(".url-prefix").attr("href",function(a,b){return baseUrl+b});(idProject=getURLParameter("project"))?$.get(baseUrl+"rest/shared/project/editor/"+idProject,function(a){console.log(a);projectData=a;showInfo(a);projectLoaded=!0;ready&&(setProfile(a.board),initToolbox(a.board,
[]));"true"===$("#editor-full-mode")&&("s3"===projectData.board?($("#prop-btn-ram").addClass("hidden"),document.getElementById("client-available").innerHTML=document.getElementById("client-available-short").innerHTML):($("#prop-btn-ram").removeClass("hidden"),document.getElementById("client-available").innerHTML=document.getElementById("client-available-long").innerHTML));timestampSaveTime(20,!0);setInterval(checkLastSavedTime,6E4)}).fail(function(){utils.showMessage("Unable to Access Project","The BlocklyProp Editor was unable to access the project you requested.  If you are sure the project exists, you may need to contact the project's owner and ask them to share their project before you will be able to view it.",
