...
projectData.board=a;projectData.code=c;projectData.name=b;$.post(baseUrl+"rest/project/board-as",projectData,function(a){projectData=a;projectData.code=c;window.location.href=baseUrl+"projecteditor?id="+a.id});timestampSaveTime(20,!0)},editProjectDetails=function(){window.location.href=baseUrl+"my/projects.jsp#"+idProject},blocklyReady=function(){getURLParameter("debug")&&(document.getElementById("tab_xml").style.display="inline-block");projectLoaded?(setProfile(projectData.board),initToolbox(projectData.board,
[])):ready=!0};window.onbeforeunload=function(){if(checkLeave())return Blockly.Msg.DIALOG_CHANGED_SINCE};var checkLeave=function(){if(ignoreSaveCheck)return!1;var a=getXml();"propcfile"===projectData.board&&(a=propcAsBlocksXml());return null===projectData?'<xml xmlns="http://www.w3.org/1999/xhtml"></xml>'===a?!1:!0:projectData.code===a?!1:!0};setInterval(function(){$.get(baseUrl+"ping")},6E4);
