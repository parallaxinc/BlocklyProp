...
document.getElementById("compile-console").scrollHeight;console.log(a);"term"===b&&a.success?serial_console():"graph"===b&&a.success&&graphing_console()})}):alert('BlocklyPropClient not available to communicate with a microcontroller\nIt may help to "Force Refresh" by pressing Control-Shift-R (Windows/Linux) or Shift-Command-R (Mac)')}
