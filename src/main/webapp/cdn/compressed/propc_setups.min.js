...
projectData.board=a;projectData.code=c;projectData.name=b;$.post(baseUrl+"rest/project/board-as",projectData,function(a){projectData=a;projectData.code=c;window.location.href=baseUrl+"projecteditor?id="+a.id});timestampSaveTime(20,!0)},editProjectDetails=function(){window.location.href=baseUrl+"my/projects.jsp#"+idProject},blocklyReady=function(){getURLParameter("debug")?document.getElementById("btn-view-xml").style.display="inline-block":document.getElementById("btn-view-xml").style.display="none";
