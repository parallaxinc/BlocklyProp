...
$(".project-owner").text("("+a.user+")");$("#project-icon").html('<img src="'+cdnUrl+{"activity-board":"images/board-icons/IconActivityBoard.png",s3:"images/board-icons/IconS3.png",heb:"images/board-icons/IconBadge.png",flip:"images/board-icons/IconFlip.png",other:"images/board-icons/IconOtherBoards.png",propcfile:"images/board-icons/IconC.png"}[a.board]+'"/>')};
function generateBlockId(){return"xxxxxxxxxxxxxxxxxxxx".replace(/[xy]/g,function(a){return"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#$%&()*+,.:;=?@[]^_`{|}~"[Math.round(86*Math.random())]})}
var propcAsBlocksXml=function(){var a='<xml xmlns="http://www.w3.org/1999/xhtml">'+('<block type="propc_file" id="'+generateBlockId()+'" x="100" y="100">');a=a+'<field name="FILENAME">single.c</field><field name="CODE">'+encodeXml(codePropC.getValue().replace("/* EMPTY_PROJECT */\n",""));return a+"</field></block></xml>"},saveProject=function(){var a="";"propcfile"===projectData.board?(a=propcAsBlocksXml(),Blockly.mainWorkspace.clear(),loadToolbox(a)):a=getXml();projectData.code=a;$.post(baseUrl+
"rest/project/code",projectData,function(b){var c=projectData.yours;projectData=b;projectData.code=a;c||(window.location.href=baseUrl+"projecteditor?id="+b.id)}).done(function(){var a=document.getElementById("save-project");a.style.paddingLeft="10px";a.style.background="rgb(92, 184, 92)";a.style.borderColor="rgb(76, 174, 76)";setTimeout(function(){a.innerHTML="Save &#x2713;"},600);setTimeout(function(){a.innerHTML="Save&nbsp;&nbsp;";a.style.paddingLeft="15px";a.style.background="#337ab7";a.style.borderColor=
"#2e6da4"},1750)}).fail(function(){var a=document.getElementById("save-project");a.style.paddingLeft="10px";a.style.background="rgb(214, 44, 44)";a.style.borderColor="rgb(191, 38, 38)";setTimeout(function(){a.innerHTML="Save &times;"},600);setTimeout(function(){a.innerHTML="Save&nbsp;&nbsp;";a.style.paddingLeft="15px";a.style.background="#337ab7";a.style.borderColor="#2e6da4"},1750);utils.showMessage("Not logged in","BlocklyProp was unable to save your project.\n\nYou may still be able to download it as a Blockls file.\n\nYou will need to return to the homepage to log back in.")});
...
a===projectData.board?(projectData.code=c,projectData.name=b,$.post(baseUrl+"rest/project/code-as",projectData,function(a){projectData=a;projectData.code=c;window.location.href=baseUrl+"projecteditor?id="+a.id})):(ignoreSaveCheck=!0,projectData.code=c,projectData.name=b,projectData.board="propcfile",$.post(baseUrl+"createproject",{"project-name":b,"board-type":a,"project-description":projectData.description,"project-type":projectData.type,sharing:projectData["private"]?"private":"shared","project-description-html":projectData["description-html"]},
function(a){console.log(a);a.success?(projectData=a,window.location.href=baseUrl+"projecteditor?id="+a.id,projectData.code=c,setTimeout(function(){$.post(baseUrl+"rest/project/code",projectData,function(a){projectData=a;projectData.code=c;ignoreSaveCheck=!1})},1E3)):"string"===typeof a.message?alert("There was an error when BlocklyProp tried to create your project:\n"+a.message):alert("There was an error when BlocklyProp tried to create your project:\n"+a.message.toString())}));timestampSaveTime(20,
!0)},editProjectDetails=function(){window.location.href=baseUrl+"my/projects.jsp#"+idProject},blocklyReady=function(){getURLParameter("debug")&&(document.getElementById("tab_xml").style.display="inline-block");projectLoaded?(setProfile(projectData.board),initToolbox(projectData.board,[])):ready=!0};window.onbeforeunload=function(){if(checkLeave())return Blockly.Msg.DIALOG_CHANGED_SINCE};
