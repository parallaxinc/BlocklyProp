...
function generateBlockId(){return"xxxxxxxxxxxxxxxxxxxx".replace(/[xy]/g,function(a){return"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"[Math.round(61*Math.random())]})}
...
projectLoaded?(setProfile(projectData.board),initToolbox(projectData.board,[])):ready=!0};window.onbeforeunload=function(){if(checkLeave())return Blockly.Msg.DIALOG_CHANGED_SINCE};
var checkLeave=function(){var a=projectData.code;"propcfile"===projectData.board&&(a=a.replace(/type="propc_file" id="[A-Z0-9a-z]*"/g,'type="propc_file" id="zzzz"'));if(ignoreSaveCheck)return!1;var b="propcfile"===projectData.board?propcAsBlocksXml().replace(/type="propc_file" id="[A-Z0-9a-z]*"/g,'type="propc_file" id="zzzz"'):getXml();return null===projectData?'<xml xmlns="http://www.w3.org/1999/xhtml"></xml>'===b?!1:!0:a===b?!1:!0};setInterval(function(){$.get(baseUrl+"ping")},6E4);
