...
Blockly.Blocks.fb360_setup={init:function(){this.setTooltip(Blockly.MSG_FB360_SETUP_TOOLTIP);"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this._menuOptions=[["set acceleration (\u00b0/s\u00b2) to","setAcceleration"],["set max speed (\u00b0/s) to","setMaxSpeed"],["turn count (+/- revolutions) to","setTurns"],
["home to position (+/- \u00b0)","setAngleOffset"],["kP for speed to","setControlSys,S360_SETTING_KPV"],["kI for speed to","setControlSys,S360_SETTING_KIV"],["kD for speed to","setControlSys,S360_SETTING_KDV"],["I for speed max to","setControlSys,S360_SETTING_IV_MAX"],["kP for position to","setControlSys,S360_SETTING_KPA"],["kI for position to","setControlSys,S360_SETTING_KIA"],["kD for position to","setControlSys,S360_SETTING_KDA"],["I for position max to","setControlSys,S360_SETTING_IA_MAX"]];this.appendValueInput("VALUE").appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),
"PIN").appendField(new Blockly.FieldDropdown(this._menuOptions,function(a){this.sourceBlock_.updateShape_(a)}),"PARAM").appendField("R,0,7200,0","RANGEVALS0");this.getField("RANGEVALS0").setVisible(!1);this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},updateShape_:function(a){"setAcceleration"===a?this.setFieldValue("R,0,7200,0","RANGEVALS0"):"setMaxSpeed"===a?this.setFieldValue("R,0,1080,0","RANGEVALS0"):this.setFieldValue("R,-2147483648,2147483647,0",
"RANGEVALS0")},mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("param",this.getFieldValue("PARAM"));return a},domToMutation:function(a){a=a.getAttribute("param");this.updateShape_(a)},onchange:function(){for(var a="WARNING: You need a Feedback 360\u00b0 servo initialize block set to match the PIN on this block!",b=Blockly.getMainWorkspace().getAllBlocks(),c=0;c<b.length;c++){var d=b[c].type,e=this.getFieldValue("PIN");"fb360_init"!==d||b[c].getFieldValue("PIN")!==
e&&b[c].getFieldValue("FB")!==e||(a=null)}this.setWarningText(a)}};Blockly.propc.fb360_setup=function(){var a=this.getFieldValue("PARAM"),b=Blockly.propc.valueToCode(this,"VALUE",Blockly.propc.ORDER_NONE)||"0",c=this.getFieldValue("PIN");return-1<Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Feedback 360\u00b0 servo initialize")?-1<a.indexOf(",")?(a=a.split(","),"servo360_"+a[0]+"("+c+", "+a[1]+", "+b+");\n"):"servo360_"+a+"("+c+", "+b+");\n":"// WARNING: You need a Feedback 360\u00b0 servo initialize block set to match the PIN on this block!"};
Blockly.Blocks.fb360_set={init:function(){this.setTooltip(Blockly.MSG_FB360_SET_TOOLTIP);"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this._menuOptions=[["set speed to (+/- \u00b0/s)","speed"],["set position to (+/- \u00b0)","angle"],["change position by (+/- \u00b0)","goto"]];this.appendValueInput("VALUE").setCheck("Number").appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),
"PIN").appendField(new Blockly.FieldDropdown(this._menuOptions,function(a){this.sourceBlock_.updateShape_(a)}),"PARAM").appendField("R,-720,720,0","RANGEVALS0");this.getField("RANGEVALS0").setVisible(!1);this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},updateShape_:function(a){"speed"===a?this.setFieldValue("R,-720,720,0","RANGEVALS0"):"angle"===a?this.setFieldValue("R,-1456,1456,0","RANGEVALS0"):this.setFieldValue("R,-2147483648,2147483647,0","RANGEVALS0")},
onchange:Blockly.Blocks.fb360_setup.onchange,mutationToDom:Blockly.Blocks.fb360_setup.mutationToDom,domToMutation:Blockly.Blocks.fb360_setup.domToMutation};Blockly.propc.fb360_set=Blockly.propc.fb360_setup;
...
Blockly.Blocks.fb360_status={init:function(){this.setTooltip(Blockly.MSG_FB360_GET_TOOLTIP);"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendDummyInput("VALUE").appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField(new Blockly.FieldDropdown([["is turning a speed",
"S360_SPEED"],["is moving to a position","S360_GOTO"],["is holding at a position","S360_POSITION"]]),"STATUS");this.setOutput(!0,"Number")},onchange:Blockly.Blocks.fb360_setup.onchange};Blockly.propc.fb360_status=function(){return-1<Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Feedback 360\u00b0 servo initialize")?["(servo360_getCsop("+this.getFieldValue("PIN")+") == "+this.getFieldValue("STATUS")+")",Blockly.propc.ORDER_NONE]:["0",Blockly.propc.ORDER_NONE]};
