...
a("es6-impl",function(){return!0});a("es7",function(){return b("2 ** 2 == 4")});a("es8",function(){return b("async () => 1, true")});return c};Blockly.Blocks||(Blockly.Blocks={});
...
b[1]?this.setFieldValue("(\u2265 "+b[0].toString(10)+")","TITLE"):-2147483647>=b[0]?this.setFieldValue("(\u2264"+b[1].toString(10)+")","TITLE"):this.setFieldValue("("+b[0].toString(10)+" to "+b[1].toString(10)+")","TITLE"):(this.removeInput("MAIN"),this.appendDummyInput("MAIN").appendField(new Blockly.FieldTextInput(c,Blockly.FieldTextInput.numberValidator),"NUM").appendField("","TITLE")):this.getField("TITLE")&&(this.removeInput("MAIN"),"S"===a[0]?this.appendDummyInput("MAIN").appendField(new Blockly.FieldRange(c,
b[0].toString(10),b[1].toString(10)),"NUM"):this.appendDummyInput("MAIN").appendField(new Blockly.FieldTextInput(c,Blockly.FieldTextInput.numberValidator),"NUM"));this.setFieldValue(a.toString(),"RVALS")}else this.getField("TITLE")&&(this.removeInput("MAIN"),this.appendDummyInput("MAIN").appendField(new Blockly.FieldTextInput(c,Blockly.FieldTextInput.numberValidator),"NUM")),this.setFieldValue("","RVALS"),this.setWarningText(null)}};
Blockly.propc.math_number=function(){var a=window.parseInt(this.getFieldValue("NUM"));return[a,0>a?Blockly.propc.ORDER_UNARY_PREFIX:Blockly.propc.ORDER_ATOMIC]};
...
"Number");this.setPreviousStatement(!1,null);this.setNextStatement(!1,null)}};Blockly.propc.math_bitwise=function(){var a=Blockly.propc.valueToCode(this,"A",Blockly.propc.ORDER_NONE),b=Blockly.propc.valueToCode(this,"B",Blockly.propc.ORDER_NONE),c=this.getFieldValue("OP");return[a+c+b,Blockly.propc.ORDER_NONE]};
Blockly.Blocks.base_delay={helpUrl:Blockly.MSG_CONTROL_HELPURL,init:function(){this.setTooltip(Blockly.MSG_BASE_DELAY_TOOLTIP);this.setColour(colorPalette.getColor("programming"));this.appendValueInput("DELAY_TIME","Number").appendField("pause (ms)").setCheck("Number");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},onchange:function(a){console.log(a)}};
...
Blockly.Blocks.logic_negate={init:function(){"Scribbler Robot"===profile["default"].description?this.setHelpUrl(Blockly.MSG_S3_MATH_HELPURL):this.setHelpUrl(Blockly.MSG_NUMBERS_HELPURL);this.setTooltip(Blockly.MSG_LOGIC_NEGATE_TOOLTIP);this.setColour(colorPalette.getColor("math"));this.setOutput(!0,"Number");this.appendValueInput("BOOL").setCheck("Number").appendField(new Blockly.FieldDropdown([["not","!"],["negate","-"],["abs","abs("]]),"OP")}};
...
Blockly.propc.find_substring=function(){var a=Blockly.propc.valueToCode(this,"SUBSTR",Blockly.propc.ORDER_ATOMIC)||"",b=Blockly.propc.valueToCode(this,"STR",Blockly.propc.ORDER_ATOMIC)||"";Blockly.propc.definitions_.find_sub="int find_sub(char *__strS, char *__subS) { char* __pos = strstr(__strS, __subS); return (__pos - __strS + 1); }\n";var c="";return[""!==a&&""!==b?c+("find_sub("+b+", "+a+")"):c+"0",Blockly.propc.ORDER_NONE]};
...
Blockly.Blocks.map_value={helpUrl:Blockly.MSG_NUMBERS_HELPURL,init:function(){this.setTooltip(Blockly.MSG_MAP_VALUE_TOOLTIP);this.setColour(colorPalette.getColor("math"));this.appendValueInput("NUMBER").setCheck("Number").appendField("map");this.appendDummyInput().appendField("with range").appendField(new Blockly.FieldTextInput("0",Blockly.FieldTextInput.numberValidator),"IMIN").appendField("(min)").appendField(new Blockly.FieldTextInput("50",Blockly.FieldTextInput.numberValidator),"IMAX").appendField("(max) to range").appendField(new Blockly.FieldTextInput("0",
Blockly.FieldTextInput.numberValidator),"FMIN").appendField("(min)").appendField(new Blockly.FieldTextInput("100",Blockly.FieldTextInput.numberValidator),"FMAX").appendField("(max)");this.setInputsInline(!0);this.setOutput(!0,"Number")}};
...
Blockly.propc.math_advanced=function(){var a=Blockly.propc.variableDB_.getName(this.getFieldValue("STORE"),Blockly.Variables.NAME_TYPE),b=Blockly.propc.valueToCode(this,"ARG1",Blockly.propc.ORDER_ATOMIC)||"1",c=Blockly.propc.valueToCode(this,"ARG2",Blockly.propc.ORDER_ATOMIC)||"1";b=b.replace(/([0-9])(\xA0| |\)|$)/g,"$1.0$2").replace(/\(int\)/g,"");c=c.replace(/([0-9])(\xA0| |\)|$)/g,"$1.0$2").replace(/\(int\)/g,"");var d=this.getFieldValue("OP"),e="";if("sin"===d||"cos"===d||"tan"===d)e=" * PI/180.0";
return a+" = (int) (((float)"+b+") * "+d+"(((float) "+c+")"+e+"));\n"};
...
a[0]).replace(/\@2/g,a[1]).replace(/\@3/g,a[2]).replace(/\@4/g,a[3]).replace(/\@5/g,a[4]),c=(this.getFieldValue("GLOBALS")||"").replace(/\@1/g,a[0]).replace(/\@2/g,a[1]).replace(/\@3/g,a[2]).replace(/\@4/g,a[3]).replace(/\@5/g,a[4]),d=(this.getFieldValue("SETUPS")||"").replace(/\@1/g,a[0]).replace(/\@2/g,a[1]).replace(/\@3/g,a[2]).replace(/\@4/g,a[3]).replace(/\@5/g,a[4]),e=(this.getFieldValue("MAIN")||"").replace(/\@1/g,a[0]).replace(/\@2/g,a[1]).replace(/\@3/g,a[2]).replace(/\@4/g,a[3]).replace(/\@5/g,
a[4]);a=(this.getFieldValue("FUNCTIONS")||"").replace(/\@1/g,a[0]).replace(/\@2/g,a[1]).replace(/\@3/g,a[2]).replace(/\@4/g,a[3]).replace(/\@5/g,a[4]);var f="";""!==b&&(Blockly.propc.definitions_["cCode"+cCode]=b+"\n");""!==c&&(Blockly.propc.global_vars_["cCode"+cCode]=c+"\n");""!==d&&(Blockly.propc.setups_["cCode"+cCode]=d+"\n");""!==e&&(f+=e);"INL"===this.getFieldValue("TYPE")&&(f+="\n");""!==a&&(Blockly.propc.methods_["cCode"+cCode]=a+"\n");cCode++;return"INL"===this.getFieldValue("TYPE")?f:[f,
Blockly.propc.ORDER_ATOMIC]};Blockly.Blocks.propc_file={init:function(){this.setColour("#000000");this.appendDummyInput().appendField(new Blockly.FieldTextInput("single.c"),"FILENAME").appendField(new Blockly.FieldTextInput(""),"CODE");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null)}};Blockly.propc.propc_file=function(){var a=this.getFieldValue("FILENAME"),b=this.getFieldValue("CODE");return"// RAW PROPC CODE\n//{{||}}\n"+a+"//{{||}}\n"+b};Blockly.Blocks||(Blockly.Blocks={});
...
b){for(var c=!1,d=0;d<this.arguments_.length;d++)Blockly.Names.equals(a,this.arguments_[d])&&(this.arguments_[d]=b,c=!0);if(c&&(this.updateParams_(),this.mutator.isVisible())){c=this.mutator.workspace_.getAllBlocks();d=0;for(var e;e=c[d];d++)"procedures_mutatorarg"==e.type&&Blockly.Names.equals(a,e.getFieldValue("NAME"))&&e.setFieldValue(b,"NAME")}},customContextMenu:function(a){var b={enabled:!0};var c=this.getFieldValue("NAME");b.text=Blockly.Msg.PROCEDURES_CREATE_DO.replace("%1",c);var d=goog.dom.createDom("mutation");
...
this.arguments_=[];this.quarkConnections_={};this.quarkIds_=null},onchange:function(){var a=this.previousConnection.targetBlock();a?0===a.toString().indexOf("new processor ")?this.setNextStatement(!1):this.setNextStatement(!0):this.setNextStatement(!0)},getProcedureCall:function(){return this.getFieldValue("NAME")},renameProcedure:function(a,b){Blockly.Names.equals(a,this.getProcedureCall())&&this.setFieldValue(b,"NAME")},setProcedureParameters_:function(a,b){var c,d=Blockly.Procedures.getDefinition(this.getProcedureCall(),
this.workspace),e=d&&d.mutator&&d.mutator.isVisible();e||(this.quarkConnections_={},this.quarkIds_=null);if(b)if(goog.array.equals(this.arguments_,a))this.quarkIds_=b;else{if(b.length!=a.length)throw"Error: paramNames and paramIds must be the same length.";this.setCollapsed(!1);this.quarkIds_||(this.quarkConnections_={},a.join("\n")==this.arguments_.join("\n")?this.quarkIds_=b:this.quarkIds_=[]);d=this.rendered;this.rendered=!1;for(var f=0;f<this.arguments_.length;f++)if(c=this.getInput("ARG"+f))c=
c.connection.targetConnection,this.quarkConnections_[this.quarkIds_[f]]=c,e&&c&&-1===b.indexOf(this.quarkIds_[f])&&(c.disconnect(),c.getSourceBlock().bumpNeighbours_());this.arguments_=[].concat(a);this.updateShape_();if(this.quarkIds_=b)for(f=0;f<this.arguments_.length;f++)e=this.quarkIds_[f],e in this.quarkConnections_&&(c=this.quarkConnections_[e],Blockly.Mutator.reconnect(c,this,"ARG"+f)||delete this.quarkConnections_[e]);(this.rendered=d)&&this.render()}},updateShape_:function(){for(var a=0;a<
...
b.toString()]);this.appendDummyInput("").appendField("get the").appendField(new Blockly.FieldDropdown([["states","STATE"],["directions","DIRECTION"]]),"ACTION").appendField("to highest PIN").appendField(new Blockly.FieldDropdown(a),"PIN_COUNT").appendField("from lowest PIN").appendField(new Blockly.FieldDropdown(c),"START_PIN")}};
...
b.toString()]);this.appendValueInput("VALUE").appendField("set the").appendField(new Blockly.FieldDropdown([["states","STATE"],["directions","DIRECTION"]]),"ACTION").appendField("to highest PIN").appendField(new Blockly.FieldDropdown(a),"PIN_COUNT").appendField("from lowest PIN").appendField(new Blockly.FieldDropdown(c),"START_PIN").appendField("using bits from").setCheck("Number")}};
...
Blockly.Blocks.base_freqout={helpUrl:Blockly.MSG_AUDIO_HELPURL,init:function(){this.setTooltip(Blockly.MSG_BASE_FREQOUT_TOOLTIP);this.setColour(colorPalette.getColor("io"));this.appendDummyInput("").appendField("frequency PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendValueInput("DURATION","Number").appendField("duration (ms)").setCheck("Number");this.appendValueInput("FREQUENCY","Number").appendField("frequency (Hz)").setCheck("Number");this.setInputsInline(!0);
this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};Blockly.propc.base_freqout=function(){var a=this.getFieldValue("PIN"),b=Blockly.propc.valueToCode(this,"DURATION",Blockly.propc.ORDER_ATOMIC)||1E3,c=Blockly.propc.valueToCode(this,"FREQUENCY",Blockly.propc.ORDER_ATOMIC)||3E3;return"freqout("+a+", "+b+", "+c+");\n"};
Blockly.Blocks.base_count={helpUrl:Blockly.MSG_ANALOG_PULSE_IN_OUT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_BASE_COUNT_TOOLTIP);this.setColour(colorPalette.getColor("io"));this.appendDummyInput("").appendField("count pulses PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendValueInput("DURATION","Number").appendField("duration (ms)").setCheck("Number");this.setInputsInline(!0);this.setPreviousStatement(!1,null);this.setNextStatement(!1,null);this.setOutput(!0,
"Number")}};Blockly.propc.base_count=function(){var a=this.getFieldValue("PIN"),b=Blockly.propc.valueToCode(this,"DURATION",Blockly.propc.ORDER_ATOMIC)||"1";return["count("+a+", "+b+")",Blockly.propc.ORDER_NONE]};
Blockly.Blocks.pulse_in={helpUrl:Blockly.MSG_ANALOG_PULSE_IN_OUT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_PULSE_IN_TOOLTIP);this.setColour(colorPalette.getColor("io"));this.appendDummyInput().appendField("pulse-in PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendDummyInput().appendField("read").appendField(new Blockly.FieldDropdown([["negative/low pulses","0"],["positive/high pulses","1"]]),"STATE");this.setInputsInline(!0);this.setPreviousStatement(!1,
null);this.setNextStatement(!1,null);this.setOutput(!0,"Number")}};Blockly.propc.pulse_in=function(){var a=this.getFieldValue("PIN"),b=this.getFieldValue("STATE");return["pulse_in("+a+", "+b+")",Blockly.propc.ORDER_NONE]};
Blockly.Blocks.pulse_out={helpUrl:Blockly.MSG_ANALOG_PULSE_IN_OUT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_PULSE_OUT_TOOLTIP);this.setColour(colorPalette.getColor("io"));this.appendDummyInput().appendField("pulse-out PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendValueInput("PULSE_LENGTH").appendField("pulse length (\u00b5s)").setCheck("Number");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};
Blockly.propc.pulse_out=function(){var a=this.getFieldValue("PIN"),b=Blockly.propc.valueToCode(this,"PULSE_LENGTH",Blockly.propc.ORDER_ATOMIC);return"pulse_out("+a+", "+b+");\n"};
Blockly.Blocks.rc_charge_discharge={helpUrl:Blockly.MSG_ANALOG_RC_TIME_HELPURL,init:function(){this.setTooltip(Blockly.MSG_RC_CHARGE_DISCHARGE_TOOLTIP);this.setColour(colorPalette.getColor("io"));this.appendDummyInput("").appendField("RC").appendField(new Blockly.FieldDropdown([["charge","0"],["discharge","1"]]),"STATE");this.appendDummyInput("").appendField("PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.setInputsInline(!0);this.setPreviousStatement(!1,null);
this.setNextStatement(!1,null);this.setOutput(!0,"Number")}};Blockly.propc.rc_charge_discharge=function(){var a=this.getFieldValue("PIN"),b=this.getFieldValue("STATE");return["rc_time("+a+", "+b+")",Blockly.propc.ORDER_NONE]};
Blockly.Blocks.eeprom_write={helpUrl:Blockly.MSG_EEPROM_HELPURL,init:function(){this.setTooltip(Blockly.MSG_EEPROM_WRITE_TOOLTIP);this.setColour(colorPalette.getColor("input"));this.appendValueInput("DATA").setCheck(null).appendField("EEPROM write").appendField(new Blockly.FieldDropdown([["number","NUMBER"],["text","TEXT"],["byte","BYTE"]]),"TYPE");this.appendValueInput("ADDRESS").appendField("R,0,7675,0","RANGEVALS0").setCheck("Number").appendField("to address");this.getField("RANGEVALS0").setVisible(!1);
this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.onchange()},onchange:function(){var a="Number";"TEXT"===this.getFieldValue("TYPE")&&(a="String");this.getInput("DATA").setCheck(a)}};
...
Blockly.Blocks.servo_move={init:function(){"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.setTooltip(Blockly.MSG_SERVO_MOVE_TOOLTIP);this.appendDummyInput().appendField("Servo PIN").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendValueInput("ANGLE").appendField("set angle (0-180\u00b0)").setCheck("Number").appendField("R,0,180,0",
"RANGEVALS1");this.getField("RANGEVALS1").setVisible(!1);this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};Blockly.propc.servo_move=function(){var a=this.getFieldValue("PIN"),b=Blockly.propc.valueToCode(this,"ANGLE",Blockly.propc.ORDER_NONE);this.disabled||(Blockly.propc.definitions_["include servo"]='#include "servo.h"');return"servo_angle("+a+", "+b+" * 10);\n"};
Blockly.Blocks.servo_speed={init:function(){"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.setTooltip(Blockly.MSG_SERVO_SPEED_TOOLTIP);this.appendDummyInput().appendField("CR Servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendValueInput("SPEED").appendField("speed").setCheck("Number");
this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};Blockly.propc.servo_speed=function(){var a=this.getFieldValue("PIN"),b=Blockly.propc.valueToCode(this,"SPEED",Blockly.propc.ORDER_NONE);this.disabled||(Blockly.propc.definitions_["include servo"]='#include "servo.h"');return"servo_speed("+a+", "+b+");\n"};
Blockly.Blocks.servo_set_ramp={helpUrl:Blockly.MSG_SERVO_HELPURL,init:function(){this.setTooltip(Blockly.MSG_SERVO_SET_RAMP_TOOLTIP);this.setColour(colorPalette.getColor("output"));this.appendDummyInput().appendField("CR Servo set ramp PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendValueInput("RAMPSTEP").appendField("rampstep (0 - 100)").setCheck("Number");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};
Blockly.propc.servo_set_ramp=function(){var a=this.getFieldValue("PIN"),b=Blockly.propc.valueToCode(this,"RAMPSTEP",Blockly.propc.ORDER_NONE);0>Number(b)?b="0":100<Number(b)&&(b="100");this.disabled||(Blockly.propc.definitions_["include servo"]='#include "servo.h"');return"servo_setramp("+a+", "+b+");\n"};
...
Blockly.Blocks.pwm_set={helpUrl:Blockly.MSG_ANALOG_PWM_HELPURL,init:function(){this.setTooltip(Blockly.MSG_PWM_SET_TOOLTIP);this.setColour(colorPalette.getColor("io"));this.appendDummyInput().appendField("PWM set PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN");this.appendDummyInput().appendField("channel").appendField(new Blockly.FieldDropdown([["A","0"],["B","1"]]),"CHANNEL");this.appendValueInput("DUTY_CYCLE",Number).appendField("R,0,100,0","RANGEVALS1").setCheck("Number").appendField("duty cycle (%)");
this.getField("RANGEVALS1").setVisible(!1);this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};Blockly.propc.pwm_set=function(){var a=this.getFieldValue("PIN"),b=this.getFieldValue("CHANNEL"),c=Blockly.propc.valueToCode(this,"DUTY_CYCLE",Blockly.propc.ORDER_NONE);0>Number(c)?c="0":100<Number(c)&&(c="100");return"pwm_start(100);\npwm_set("+a+", "+b+", "+c+");\n"};
...
Blockly.Blocks.ab_drive_init={helpUrl:Blockly.MSG_ROBOT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_ROBOT_DRIVE_INIT_TOOLTIP);this.setColour(colorPalette.getColor("robot"));this.appendDummyInput().appendField("Robot").appendField(new Blockly.FieldDropdown([["ActivityBot","abdrive.h"],["Arlo","arlodrive.h"],["Servo Differential Drive","servodiffdrive.h"]],function(a){this.sourceBlock_.updateShape_({BOT:a})}),"BOT").appendField("initialize");this.appendDummyInput("PINS");this.setInputsInline(!0);
this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},mutationToDom:function(){var a=document.createElement("mutation"),b=this.getFieldValue("BOT");a.setAttribute("BOT",b);return a},domToMutation:function(a){a=a.getAttribute("BOT");this.updateShape_({BOT:a})},updateShape_:function(a){var b=a.BOT;void 0===a.BOT&&(b=this.getFieldValue("BOT"));this.removeInput("PINS");this.appendDummyInput("PINS");a=this.getInput("PINS");"servodiffdrive.h"===b&&a.appendField(" left PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),
"LEFT").appendField("right PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"RIGHT");a=Blockly.getMainWorkspace().getAllBlocks();for(var c=0;c<a.length;c++){var d=a[c].newRobot;d&&d.call(a[c],b)}"arlodrive.h"===b?this.setWarningText("The Arlo robot is only partially supported in BlocklyProp at this time. Most blocks will work, some will not."):this.setWarningText(null)}};
Blockly.propc.ab_drive_init=function(){var a=this.getFieldValue("BOT");if(!this.disabled&&(Blockly.propc.definitions_["include abdrive"]='#include "'+a+'"',"servodiffdrive.h"===a)){a=Number(this.getFieldValue("LEFT"));var b=Number(this.getFieldValue("RIGHT"));Blockly.propc.setups_.servodiffdrive="drive_pins("+a+","+b+");\n"}return""};
Blockly.Blocks.ab_drive_ramping={helpUrl:Blockly.MSG_ROBOT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_ROBOT_RAMPING_TOOLTIP);this.setColour(colorPalette.getColor("robot"));this.appendDummyInput("ACCEL").appendField("Robot set acceleration for","TITLE").appendField(new Blockly.FieldDropdown([["speed","FOR_SPEED"],["distance","FOR_GOTO"]]),"OPS").appendField("blocks to","TITLE_2").appendField(new Blockly.FieldDropdown([["2000 ticks/s\u00b2","2000"],["1600 ticks/s\u00b2 (jerky)","1600"],["1200 ticks/s\u00b2",
"1200"],["800 ticks/s\u00b2 (peppy)","800"],["600 ticks/s\u00b2","600"],["400 ticks/s\u00b2 (smooth)","400"],["200 ticks/s\u00b2","200"],["100 ticks/s\u00b2 (sluggish)","100"]]),"RAMPING");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.whichBot()},whichBot:function(){var a="",b=Blockly.getMainWorkspace().getAllBlocks().toString();-1<b.indexOf("Robot ActivityBot initialize")?a="abdrive.h":-1<b.indexOf("Robot ActivityBot 360\u00b0 initialize")?a="abdrive360.h":
-1<b.indexOf("Robot Arlo initialize")?a="arlodrive.h":-1<b.indexOf("Robot Servo Differential Drive initialize")&&(a="servodiffdrive.h");this.newRobot(a)},newRobot:function(a){"abdrive.h"===a||"arlodrive.h"===a?(this.setFieldValue("Robot set acceleration for","TITLE"),this.getField("TITLE_2").setVisible(!0),this.getField("OPS").setVisible(!0),this.getField("RAMPING").setVisible(!0)):""===a?(this.setFieldValue("Robot set acceleration","TITLE"),this.getField("TITLE_2").setVisible(!1),this.getField("OPS").setVisible(!1),
this.getField("RAMPING").setVisible(!1)):(this.setFieldValue("Robot set acceleration to","TITLE"),this.getField("TITLE_2").setVisible(!1),this.getField("OPS").setVisible(!1),this.getField("RAMPING").setVisible(!0));this.render()}};
...
this.setInputsInline(!1);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.whichBot()},whichBot:Blockly.Blocks.ab_drive_ramping.whichBot,newRobot:function(a){"servodiffdrive.h"===a?this.setWarningText("WARNING: Servo Differential Drive\ndoes not support this block"):""===a?this.setWarningText("WARNING: You must use a Robot initialize\nblock at the beginning of your program!"):this.setWarningText(null)},applyTo:function(a){"FOR_SPEED"===a?this.setFieldValue("Robot set max speed (+/-) for",
"TITLE"):"FOR_GOTO"===a&&this.setFieldValue("Robot set speed (+/-) for","TITLE")}};
...
Blockly.Blocks.activitybot_calibrate={helpUrl:Blockly.MSG_ROBOT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_ACTIVITYBOT_CALIBRATE_TOOLTIP);this.setColour(colorPalette.getColor("robot"));this.appendDummyInput().appendField("ActivityBot calibrate")}};Blockly.propc.activitybot_calibrate=function(){Blockly.propc.definitions_.activitybot_calibrate='#include "abcalibrate.h"';Blockly.propc.setups_.activitybot_calibrate="cal_servoPins(12, 13);\n\tcal_encoderPins(14, 15);";return"high(26);\nhigh(27);\ncal_activityBot();\nlow(26);\nlow(27);\n"};
Blockly.Blocks.activitybot_display_calibration={helpUrl:Blockly.MSG_ROBOT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_ACTIVITYBOT_DISPLAY_CALIBRATION_TOOLTIP);this.setColour(colorPalette.getColor("robot"));this.appendDummyInput().appendField("ActivityBot display calibration").appendField(new Blockly.FieldDropdown([["results","result"],["interpolation table","table"]]),"TYPE")}};
Blockly.propc.activitybot_display_calibration=function(){Blockly.propc.definitions_["include abdrive"]='#include "abdrive.h"';Blockly.propc.serial_terminal_=!0;return"table"===this.getFieldValue("TYPE")?"drive_displayInterpolation();\n":"drive_calibrationResults();\n"};
...
"ck_nl");this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.setInputsInline(!1);this.setMutator(new Blockly.Mutator("console_print_str console_print_dec console_print_hex console_print_bin console_print_float console_print_char".split(" ")));this.optionList_=["str","dec"];this.setWarningText(null)},mutationToDom:function(){var a=document.createElement("mutation"),b=[];a.setAttribute("options",JSON.stringify(this.optionList_));for(var c=0;c<this.optionList_.length;c++)b.push(this.getFieldValue("DIV"+
c)||"0");a.setAttribute("divisors",JSON.stringify(b));return a},domToMutation:function(a){this.removeInput("PRINT0");this.removeInput("PRINT1");this.removeInput("NEWLINE");var b=JSON.parse(a.getAttribute("options"));a=JSON.parse(a.getAttribute("divisors"));this.optionList_=b;for(b=0;b<this.optionList_.length;b++){var c="decimal number",d="Number";"str"===this.optionList_[b]?(c="text",d="String"):"char"===this.optionList_[b]?c="ASCII character":"hex"===this.optionList_[b]?c="hexadecimal number":"bin"===
this.optionList_[b]&&(c="binary number");"float"===this.optionList_[b]?(this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(d).appendField("float point  divide by","TYPE"+b).appendField(new Blockly.FieldDropdown([["1","1"],["10","10"],["100","100"],["1000","1000"],["10,000","10000"],["100,000","100000"],["1,000,000","1000000"]]),"DIV"+b),this.setFieldValue(a[b],"DIV"+b)):this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(d).appendField(c,"TYPE"+b)}"console_print_multiple"===
this.type&&this.appendDummyInput("NEWLINE").appendField("then a new line").appendField(new Blockly.FieldCheckbox("FALSE"),"ck_nl")},decompose:function(a){var b=Blockly.Block.obtain(a,"console_print_container");b.initSvg();for(var c=b.getInput("STACK").connection,d=0;d<this.optionList_.length;d++){var e=a.newBlock("console_print_"+this.optionList_[d]);e.initSvg();c.connect(e.previousConnection);c=e.nextConnection}return b},compose:function(a){for(var b=0;this.getInput("PRINT"+b);)this.removeInput("PRINT"+
b),b++;this.removeInput("NEWLINE");b=0;this.optionList_.length=0;a=a.getInputTargetBlock("STACK");for(var c="",d;a;)d="Number","console_print_dec"===a.type?(this.optionList_.push("dec"),c="decimal number"):"console_print_hex"===a.type?(this.optionList_.push("hex"),c="hexadecimal number"):"console_print_bin"===a.type?(this.optionList_.push("bin"),c="binary number"):"console_print_char"===a.type?(this.optionList_.push("char"),c="ASCII character"):"console_print_str"===a.type&&(this.optionList_.push("str"),
d="String",c="text"),"console_print_float"===a.type?(this.optionList_.push("float"),d=this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(d).appendField("float point  divide by","TYPE"+b).appendField(new Blockly.FieldDropdown([["1","1"],["10","10"],["100","100"],["1000","1000"],["10,000","10000"],["100,000","100000"],["1,000,000","1000000"]]),"DIV"+b),this.setFieldValue("100","DIV"+b)):d=this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(d).appendField(c,"TYPE"+
b),a.valueConnection_&&d.connection.connect(a.valueConnection_),b++,a=a.nextConnection&&a.nextConnection.targetBlock();"console_print_multiple"===this.type&&this.appendDummyInput("NEWLINE").appendField("then a new line").appendField(new Blockly.FieldCheckbox("FALSE"),"ck_nl")},saveConnections:function(a){a=a.getInputTargetBlock("STACK");for(var b=0;a;){var c=this.getInput("PRINT"+b);a.valueConnection_=c&&c.connection.targetConnection;a=a.nextConnection&&a.nextConnection.targetBlock();b++}},onchange:function(){var a=
null;this.workspace&&1>this.optionList_.length&&(a="Terminal print multiple must have at least one term.");this.setWarningText(a)}};Blockly.Blocks.console_print_container={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("send");this.appendStatementInput("STACK");this.contextMenu=!1}};
Blockly.Blocks.console_print_dec={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("decimal number");this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.contextMenu=!1}};Blockly.Blocks.console_print_hex={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("hexadecimal number");this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.contextMenu=!1}};
Blockly.Blocks.console_print_bin={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("binary number");this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.contextMenu=!1}};Blockly.Blocks.console_print_str={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("text");this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.contextMenu=!1}};
Blockly.Blocks.console_print_char={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("ASCII character");this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.contextMenu=!1}};Blockly.Blocks.console_print_float={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("floating point number");this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.contextMenu=!1}};
Blockly.propc.console_print_multiple=function(){Blockly.propc.serial_terminal_=!0;for(var a='print("',b="",c="",d=0;this.getInput("PRINT"+d);)this.getFieldValue("TYPE"+d).includes("decimal number")?(a+="%d",c="0"):this.getFieldValue("TYPE"+d).includes("hexadecimal number")?(a+="%x",c="0x0"):this.getFieldValue("TYPE"+d).includes("binary number")?(a+="%b",c="0b0"):this.getFieldValue("TYPE"+d).includes("text")?(a+="%s",c='" "'):this.getFieldValue("TYPE"+d).includes("ASCII character")?(a+="%c",c="32"):
this.getFieldValue("TYPE"+d).includes("float point  divide by")&&(a+="%f",c="0"),b=this.getFieldValue("TYPE"+d).includes("float point  divide by")?b+(", ((float) "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)+") / "+this.getFieldValue("DIV"+d)+".0"):b+(", "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)),d++;"TRUE"===this.getFieldValue("ck_nl")&&(a+="\\r");return a+('"'+b+");\n")};
...
"2400"],["4800","4800"],["9600","9600"],["19200","19200"],["38400","38400"],["57600","57600"],["115200","115200"],["other","other"]],function(a){this.sourceBlock_.setToOther(a)}),"BAUD");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.otherBaud=!1;this.serialPin=this.getFieldValue("RXPIN")+","+this.getFieldValue("TXPIN");this.onchange({oldXml:!0})},onchange:function(a){this.serialPin=this.getFieldValue("RXPIN")+","+this.getFieldValue("TXPIN");if(a.blockId===
this.id||a.oldXml)for(var b=Blockly.getMainWorkspace().getAllBlocks(),c=0;c<b.length;c++){var d=b[c].serPins;d&&("RXPIN"===a.name?d.call(b[c],a.oldValue+","+this.getFieldValue("TXPIN"),a.newValue+","+this.getFieldValue("TXPIN")):"TXPIN"===a.name?d.call(b[c],this.getFieldValue("RXPIN")+","+a.oldValue,this.getFieldValue("RXPIN")+","+a.newValue):a.oldXml&&d.call(b[c]))}},setToOther:function(a){"other"===a&&(this.otherBaud=!0,this.removeInput("BAUD_RATE"),this.appendDummyInput("BAUD_RATE").appendField("baud").appendField(new Blockly.FieldTextInput("1200",
Blockly.FieldTextInput.numberValidator),"BAUD"))},mutationToDom:function(){if(this.otherBaud){var a=document.createElement("mutation");a.setAttribute("baud",this.getFieldValue("BAUD"));return a}},domToMutation:function(a){a=a.getAttribute("baud");void 0!==a&&(this.otherBaud=!0,this.removeInput("BAUD_RATE"),this.appendDummyInput("BAUD_RATE").appendField("baud").appendField(new Blockly.FieldTextInput(a,Blockly.FieldTextInput.numberValidator),"BAUD"))}};
Blockly.propc.serial_open=function(){var a=this.getFieldValue("RXPIN").replace("None","-1"),b=this.getFieldValue("TXPIN").replace("None","-1"),c=this.getFieldValue("RXPIN").replace("None","N"),d=this.getFieldValue("TXPIN").replace("None","N"),e=this.getFieldValue("BAUD");this.disabled||(Blockly.propc.definitions_["include fdserial"]='#include "fdserial.h"',Blockly.propc.definitions_["var fdserial"+c+"_"+d]="fdserial *fdser"+c+"_"+d+";",Blockly.propc.setups_["setup_fdserial"+c+"_"+d]="fdser"+c+"_"+
d+" = fdserial_open("+a+", "+b+", 0, "+e+");");return""};
...
else{var a=null;this.workspace&&1>this.optionList_.length&&(a="Serial transmit multiple must have at least one term.");this.setWarningText(a)}}};
Blockly.propc.serial_print_multiple=function(){var a="";0<this.ser_pins.length&&(a=this.ser_pins[0][0].replace(",","_"));this.getInput("SERPIN")&&(a=this.getFieldValue("SER_PIN").replace(",","_"));if(-1===Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Serial initialize"))return"// ERROR: Serial is not initialized!\n";a="dprint(fdser"+a+', "';for(var b="",c="",d=0;this.getInput("PRINT"+d);)this.getFieldValue("TYPE"+d).includes("decimal number")?(a+="%d",c="0"):this.getFieldValue("TYPE"+
d).includes("hexadecimal number")?(a+="%x",c="0x0"):this.getFieldValue("TYPE"+d).includes("binary number")?(a+="%b",c="0b0"):this.getFieldValue("TYPE"+d).includes("text")?(a+="%s",c='" "'):this.getFieldValue("TYPE"+d).includes("ASCII character")?(a+="%c",c="32"):this.getFieldValue("TYPE"+d).includes("float point  divide by")&&(a+="%f",c="0"),b=this.getFieldValue("TYPE"+d).includes("float point  divide by")?b+(", ((float) "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)+") / "+this.getFieldValue("DIV"+
d)+".0"):b+(", "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)),d++;"TRUE"===this.getFieldValue("ck_nl")&&(a+="\\r");return a+('"'+b+");\n")};
...
Blockly.propc.debug_lcd_set_cursor=function(){if(-1===Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("LCD initialize"))return"// LCD: Serial is not initialized!\n";if(!this.disabled){var a=Blockly.propc.valueToCode(this,"ROW",Blockly.propc.ORDER_NONE);var b=Blockly.propc.valueToCode(this,"COLUMN",Blockly.propc.ORDER_NONE);Blockly.propc.methods_.constrain_function="int constrain(int __cVal, int __cMin, int __cMax) {if(__cVal < __cMin) __cVal = __cMin;\nif(__cVal > __cMax) __cVal = __cMax;\nreturn __cVal;\n}\n";
...
Blockly.propc.xbee_print_multiple=function(){if(-1===Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("XBee initialize"))return"// ERROR: XBee is not initialized!\n";for(var a='dprint(xbee, "',b="",c="",d=0;this.getInput("PRINT"+d);)this.getFieldValue("TYPE"+d).includes("decimal number")?(a+="%d",c="0"):this.getFieldValue("TYPE"+d).includes("hexadecimal number")?(a+="%x",c="0x0"):this.getFieldValue("TYPE"+d).includes("binary number")?(a+="%b",c="0b0"):this.getFieldValue("TYPE"+d).includes("text")?
(a+="%s",c='" "'):this.getFieldValue("TYPE"+d).includes("ASCII character")?(a+="%c",c="32"):this.getFieldValue("TYPE"+d).includes("float point  divide by")&&(a+="%f",c="0"),b=this.getFieldValue("TYPE"+d).includes("float point  divide by")?b+(", ((float) "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)+") / "+this.getFieldValue("DIV"+d)+".0"):b+(", "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)),d++;"TRUE"===this.getFieldValue("ck_nl")&&(a+="\\r");return a+('"'+
b+");\n")};
Blockly.Blocks.xbee_scan_multiple={helpUrl:Blockly.MSG_XBEE_HELPURL,init:function(){this.setTooltip(Blockly.MSG_XBEE_SCAN_MULTIPLE_TOOLTIP);this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("XBee receive");this.optionList_=["dec","char"];this.updateShape_();this.setPreviousStatement(!0,"Block");this.setNextStatement(!0);this.setMutator(new Blockly.Mutator(["console_print_dec","console_print_hex","console_print_bin","console_print_float","console_print_char"]));this.setWarningText(null);
this.ser_pins=[]},mutationToDom:Blockly.Blocks.serial_scan_multiple.mutationToDom,domToMutation:Blockly.Blocks.serial_scan_multiple.domToMutation,decompose:Blockly.Blocks.serial_scan_multiple.decompose,compose:Blockly.Blocks.serial_scan_multiple.compose,saveConnections:Blockly.Blocks.serial_scan_multiple.saveConnections,updateShape_:Blockly.Blocks.serial_scan_multiple.updateShape_,updateSerPin:function(){},onchange:function(){var a=null;-1===Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("XBee initialize")&&
...
Blockly.Blocks.wx_init={helpUrl:Blockly.MSG_SWX_HELPURL,init:function(){this.setTooltip(Blockly.MSG_SWX_INIT_TOOLTIP);(new Blockly.FieldColour("#FFFFFF")).setColours(["#FFFFFF","#000000"]).setColumns(2);this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("Simple WX initialize").appendField("mode").appendField(new Blockly.FieldDropdown([["Terminal on USB","USB_PGM_TERM"],["Terminal on WX","USB_PGM"],["Term & Programming on WX","WX_ALL_COM"]]),"MODE").appendField(" DO").appendField(new Blockly.FieldDropdown([["WX Socket",
"31"]].concat(profile["default"].digital),function(a){this.sourceBlock_.updateShape_({PIN:a})}),"DO");this.appendDummyInput("DIPIN").appendField("DI").appendField(new Blockly.FieldDropdown(profile["default"].digital),"DI");this.getInput("DIPIN").setVisible(!1);this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},mutationToDom:function(){var a=document.createElement("mutation"),b=this.getFieldValue("DO");a.setAttribute("pin",b);return a},domToMutation:function(a){a=
a.getAttribute("pin");this.updateShape_({PIN:a})},updateShape_:function(a){"31"===a.PIN?this.getInput("DIPIN").setVisible(!1):this.getInput("DIPIN").setVisible(!0)}};
Blockly.propc.wx_init=function(){if(!this.diabled){var a=this.getFieldValue("DO"),b=this.getFieldValue("DI");"31"===a&&(b="30");this.getFieldValue("BKG");this.getFieldValue("TITLE");var c=this.getFieldValue("MODE");a=""+("wifi_start("+a+", "+b+", 115200, "+c+");\n")+'wifi_setBuffer(__wxBffr, sizeof(__wxBffr));\n__wsId = wifi_listen(WS, "/ws/a");\n';a+="while(!__wsHandle) {\n  wifi_poll(&__wxEvent, &__wxId, &__wxHandle);\n";a+="  if(__wxEvent == 'W' && __wxId == __wsId)  __wsHandle = __wxHandle;\n}";
...
Blockly.Blocks.wx_init_adv={helpUrl:Blockly.MSG_AWX_HELPURL,init:function(){this.setTooltip(Blockly.MSG_AWX_INIT_ADV_TOOLTIP);(new Blockly.FieldColour("#FFFFFF")).setColours(["#FFFFFF","#000000"]).setColumns(2);this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("WX initialize").appendField("mode").appendField(new Blockly.FieldDropdown([["Terminal on USB","USB_PGM_TERM"],["Terminal on WX","USB_PGM"],["Term & Programming on WX","WX_ALL_COM"]]),"MODE").appendField(" DO").appendField(new Blockly.FieldDropdown([["WX Socket",
"31"]].concat(profile["default"].digital),function(a){this.sourceBlock_.updateShape_({PIN:a})}),"DO");this.appendDummyInput("DIPIN").appendField("DI").appendField(new Blockly.FieldDropdown(profile["default"].digital),"DI");this.getInput("DIPIN").setVisible(!1);this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.setWarningText(null)},onchange:function(){var a=Blockly.getMainWorkspace().getAllBlocks();if(-1===a.toString().indexOf("WX initialize"))this.setWarningText("WARNING: You must use a WX\ninitialize block at the beginning of your program!");
else{for(var b=null,c=0;c<a.length;c++)0===a[c].toString().indexOf("Simple WX")&&(b="WARNING: You cannot use Advanced WX and\nSimple WX blocks together in your project!");this.setWarningText(b)}},mutationToDom:function(){var a=document.createElement("mutation"),b=this.getFieldValue("DO");a.setAttribute("pin",b);return a},domToMutation:function(a){a=a.getAttribute("pin");this.updateShape_({PIN:a})},updateShape_:function(a){"31"===a.PIN?this.getInput("DIPIN").setVisible(!1):this.getInput("DIPIN").setVisible(!0)}};
Blockly.propc.wx_init_adv=function(){if(!this.disabled){var a=this.getFieldValue("DO"),b=this.getFieldValue("DI");"31"===a&&(b="30");this.getFieldValue("BKG");this.getFieldValue("TITLE");var c=this.getFieldValue("MODE");Blockly.propc.definitions_.wx_def='#include "wifi.h"';Blockly.propc.setups_.wx_init="wifi_start("+a+", "+b+", 115200, "+c+");\n"}return""};
...
this.workspace&&1>this.optionList_.length&&(b="WX scan must have at least one search term.");this.setWarningText(b)}},getVars:function(){return[this.getFieldValue("HANDLE")]},renameVar:function(a,b){Blockly.Names.equals(a,this.getFieldValue("HANDLE"))&&this.setFieldValue(b,"HANDLE")}};
Blockly.propc.wx_print_multiple=function(){var a=Blockly.getMainWorkspace().getAllBlocks().toString();if(-1===a.indexOf("Simple WX initialize")&&-1<a.indexOf("WX initialize")){a=Blockly.propc.variableDB_.getName(this.getFieldValue("HANDLE"),Blockly.Variables.NAME_TYPE);a="wifi_print("+this.getFieldValue("CONNECTION")+", "+a+', "';for(var b="",c=0,d="";this.getInput("PRINT"+c);)this.getFieldValue("TYPE"+c).includes("decimal number")?(a+="%d",d="0"):this.getFieldValue("TYPE"+c).includes("hexadecimal number")?
(a+="%x",d="0x0"):this.getFieldValue("TYPE"+c).includes("binary number")?(a+="%b",d="0b0"):this.getFieldValue("TYPE"+c).includes("text")?(a+="%s",d='" "'):this.getFieldValue("TYPE"+c).includes("ASCII character")?(a+="%c",d="32"):this.getFieldValue("TYPE"+c).includes("float point  divide by")&&(a+="%f",d="0"),b=this.getFieldValue("TYPE"+c).includes("float point  divide by")?b+(", ((float) "+Blockly.propc.valueToCode(this,"PRINT"+c,Blockly.propc.NONE||d)+") / "+this.getFieldValue("DIV"+c)+".0"):b+(", "+
Blockly.propc.valueToCode(this,"PRINT"+c,Blockly.propc.NONE||d)),c++;return a+('"'+b+");\n")}return"// ERROR: WX is not initialized!\n"};
...
Blockly.propc.wx_mode=function(){var a=Blockly.getMainWorkspace().getAllBlocks().toString();return-1===a.indexOf("Simple WX initialize")&&-1<a.indexOf("WX initialize")?(a=this.getFieldValue("MODE"),"CHECK"===this.getFieldValue("ACTION")?["wifi_mode(CHECK)",Blockly.propc.ORDER_NONE]:"LEAVE"===a?"wifi_leave("+a+");\n":"wifi_mode("+a+");\n"):"// ERROR: WX is not initialized!\n"};
...
Blockly.propc.keypad_initialize=function(){this.disabled||(Blockly.propc.global_vars_["4x4keypad"]="int keypad_button(int __a, int __b, int __c, int __d, int __e, int __f, int __g, int __h) {int __press = 0, __k, __j, __keytimeout = CNT + CLKFREQ/10;\nint __keypad[] = {__a, __b, __c, __d, __e, __f, __g, __h};\nint __keyval[] = {1,4,7,15,2,5,8,0,3,6,9,14,10,11,12,13};\nwhile(CNT < __keytimeout) {for(__k = 4; __k < 8; __k++) input(__keypad[__k]);\nfor(__k = 0; __k < 4; __k++) {for(__j = 0; __j < 4; __j++) low(__keypad[__j]);\nhigh(__keypad[__k]);\nfor(__j = 4; __j < 8; __j++) {__press = input(__keypad[__j]);\nif(__press) break;}if(__press) return __keyval[__k | ((__j - 4) << 2)];}}return -1;}");return""};
...
this.getField("RANGEVALS2").setVisible(!1);this.setInputsInline(!1);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.setColour(colorPalette.getColor("io"));this.setHelpUrl(Blockly.MSG_S3_MOTORS_HELPURL);this.setTooltip(Blockly.MSG_S3_MOVE_MOTORS_XY_TOOLTIP)},newUnit:function(a){var b=this.getInput("X_DISTANCE").connection,c=this.getInput("Y_DISTANCE").connection.targetBlock();b=b.targetBlock();var d="R,-20755429,20755429,0";" * 10000 / 1933"===a?d="R,-207554294,207554294,0":
" * 10000 / 491"===a?d="R,-52720723,52720723,0":" * 1000 / 491"===a?d="R,-527207235,527207235,0":""===a&&(d="R,-1073741823,1073741823,0");this.setFieldValue(d,"RANGEVALS0");this.setFieldValue(d,"RANGEVALS1");c&&c.onchange&&c.onchange.call(c);b&&b.onchange&&b.onchange.call(b)}};
Blockly.propc.move_motors_xy=function(){var a=this.getFieldValue("MULTIPLIER"),b=Blockly.propc.valueToCode(this,"X_DISTANCE",Blockly.propc.ORDER_ATOMIC)||"0",c=Blockly.propc.valueToCode(this,"Y_DISTANCE",Blockly.propc.ORDER_ATOMIC)||"0";return"scribbler_set_speed("+(Blockly.propc.valueToCode(this,"MOTOR_SPEED",Blockly.propc.ORDER_ATOMIC)||"0")+" * 3 / 20);\nscribbler_move_to("+b+a+", "+c+a+");\n"};
...
Blockly.Blocks.stall_sensor={init:function(){this.appendDummyInput("").appendField("stall sensor").appendField(new Blockly.FieldDropdown([["tail wheel is stopped","s3_stalled()"],["tail wheel is spinning","!s3_stalled()"],["drive wheels stalled","!s3_motorsMoving()"],["drive wheels turning","s3_motorsMoving()"],["Scribbler is stuck","s3_simpleStalled(S3_IS)"],["Scribbler is not stuck","s3_simpleStalled(S3_IS_NOT)"]]),"STALL_SENSOR_CHOICE");this.setOutput(!0,"Number");this.setColour(colorPalette.getColor("input"));
this.setHelpUrl(Blockly.MSG_S3_STALL_HELPURL);this.setTooltip(Blockly.MSG_S3_STALL_SENSOR_TOOLTIP)}};Blockly.propc.stall_sensor=function(){return[this.getFieldValue("STALL_SENSOR_CHOICE"),Blockly.propc.ORDER_ATOMIC]};Blockly.Blocks.button_pressed={init:function(){this.appendDummyInput("").appendField("the red botton is currently pressed");this.appendDummyInput("").appendField("(true or false)");this.setOutput(!0,"Number");this.setColour(colorPalette.getColor("input"))}};
...
Blockly.Blocks.scribbler_stop_servo={init:function(){"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.setTooltip(Blockly.MSG_S3_SCRIBBLER_STOP_SERVO_TOOLTIP);this.appendDummyInput("").appendField("servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"SERVO_PIN").appendField("disable");
this.setInputsInline(!1);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};Blockly.propc.scribbler_stop_servo=function(){Blockly.propc.definitions_["include servo"]='#include "servo.h"';return"servo_disable("+this.getFieldValue("SERVO_PIN")+");\n"};
...
"void s3_calibrate_line_sensor(void);";return"s3_calibrate_line_sensor();"};