...
"2400"],["4800","4800"],["9600","9600"],["19200","19200"],["38400","38400"],["57600","57600"],["115200","115200"],["other","other"]],function(a){this.sourceBlock_.setToOther(a)}),"BAUD");this.appendDummyInput("MODE").appendField("mode").appendField(new Blockly.FieldDropdown([["standard","standard"],["other","other"]],function(){this.sourceBlock_.setToMode()}),"TYPE");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.otherMode=this.otherBaud=!1;this.serialPin=
this.getFieldValue("RXPIN")+","+this.getFieldValue("TXPIN");this.onchange({oldXml:!0})},onchange:function(a){this.serialPin=this.getFieldValue("RXPIN")+","+this.getFieldValue("TXPIN");if(a.blockId===this.id||a.oldXml)for(var b=Blockly.getMainWorkspace().getAllBlocks(),c=0;c<b.length;c++){var d=b[c].serPins;d&&("RXPIN"===a.name?d.call(b[c],a.oldValue+","+this.getFieldValue("TXPIN"),a.newValue+","+this.getFieldValue("TXPIN")):"TXPIN"===a.name?d.call(b[c],this.getFieldValue("RXPIN")+","+a.oldValue,this.getFieldValue("RXPIN")+
","+a.newValue):a.oldXml&&d.call(b[c]))}},setToOther:function(a){"other"===a&&(a="1200");this.otherBaud=!0;this.removeInput("BAUD_RATE");this.appendDummyInput("BAUD_RATE").appendField("baud").appendField(new Blockly.FieldTextInput(a,Blockly.FieldTextInput.numberValidator),"BAUD");this.moveInputBefore("BAUD_RATE","MODE")},setToMode:function(a){a||(a=["FALSE","FALSE","FALSE","FALSE"]);this.removeInput("MODE");this.appendDummyInput("MODE").appendField("invert RX").appendField(new Blockly.FieldCheckbox(a[0]),
"ck_bit0").appendField("invert TX").appendField(new Blockly.FieldCheckbox(a[1]),"ck_bit1").appendField("open-drain").appendField(new Blockly.FieldCheckbox(a[2]),"ck_bit2").appendField("remove TX echos").appendField(new Blockly.FieldCheckbox(a[3]),"ck_bit3");this.otherMode=!0},mutationToDom:function(){if(this.otherBaud||this.otherMode){var a=document.createElement("mutation");a.setAttribute("baud",this.getFieldValue("BAUD")||"1200");for(var b=0;4>b;b++)a.setAttribute("ck_bit"+b.toString(10),this.getFieldValue("ck_bit"+
b.toString(10))||"FALSE");return a}},domToMutation:function(a){var b=a.getAttribute("baud");void 0!==b&&(this.otherBaud=this.setToOther(b));b=["FALSE","FALSE","FALSE","FALSE"];for(var c=!1,d=0;4>d;d++)b[d]=a.getAttribute("ck_bit"+d.toString(10)),"TRUE"===b[d]&&(c=!0);c&&this.setToMode(b)}};
