...
Blockly.propc.activitybot_calibrate=function(){var a=this.getFieldValue("BOT")||"abcalibrate.h",b="";"abcalibrate360.h"===a&&(b="#include servo360.h\n");Blockly.propc.definitions_.activitybot_calibrate=b+'#include "'+a+'"';Blockly.propc.setups_.activitybot_calibrate="cal_servoPins(12, 13);\n\tcal_encoderPins(14, 15);";return"high(26);\nhigh(27);\ncal_activityBot();\nlow(26);\nlow(27);\n"};
...
Blockly.propc.activitybot_display_calibration=function(){var a=this.getFieldValue("BOT")||"abdrive.h",b="";"abcalibrate360.h"===a&&(b="#include servo360.h\n");Blockly.propc.definitions_.activitybot_calibrate=b+'#include "'+a+'"';Blockly.propc.serial_terminal_=!0;return"abdrive.h"===a?"table"===this.getFieldValue("TYPE")?"drive_displayInterpolation();\n":"drive_calibrationResults();\n":"table"===this.getFieldValue("TYPE")?"cal_displayResults();\n":"cal_displayData();\n"};
