...
Blockly.propc.console_print_multiple=function(){Blockly.propc.serial_terminal_=!0;for(var a='print("',b="",c="",d=0;this.getInput("PRINT"+d);){var e=this.getFieldValue("DIGIT"+d)||"";this.getFieldValue("PLACE"+d)&&""!==this.getFieldValue("PLACE"+d)&&(e+="."+this.getFieldValue("PLACE"+d));this.getFieldValue("TYPE"+d).includes("decimal number")?(a+="%"+e+"d",c="0"):this.getFieldValue("TYPE"+d).includes("hexadecimal number")?(a+="%"+e+"x",c="0x0"):this.getFieldValue("TYPE"+d).includes("binary number")?
(a+="%"+e+"b",c="0b0"):this.getFieldValue("TYPE"+d).includes("text")?(a+="%s",c='" "'):this.getFieldValue("TYPE"+d).includes("ASCII character")?(a+="%c",c="32"):this.getFieldValue("TYPE"+d).includes("float point  divide by")&&(a+="%"+e+"f",c="0");b=this.getFieldValue("TYPE"+d).includes("float point  divide by")?b+(", ((float) "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)+") / "+this.getFieldValue("DIV"+d)+".0"):b+(", "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||
