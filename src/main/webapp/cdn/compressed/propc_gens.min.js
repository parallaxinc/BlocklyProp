...
this.getField("RANGEVALS0").setVisible(!1);this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null);this.setOutputType_(this.getFieldValue("DATA"))},mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("type",this.getFieldValue("DATA"));return a},domToMutation:function(a){(a=a.getAttribute("type"))||(a=this.getFieldValue("TYPE"));this.setOutputType_(a||"NUMBER")},setOutputType_:function(a){var b="Number";"TEXT"===a&&(b="String");this.getInput("DATA").setCheck(b)}};
