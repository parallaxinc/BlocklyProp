...
Blockly.propc.fb360_get=function(){return-1<Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Feedback 360\u00b0 servo initialize")?["servo360_getAngle("+this.getFieldValue("PIN")+")",Blockly.propc.ORDER_NONE]:["0",Blockly.propc.ORDER_NONE]};
