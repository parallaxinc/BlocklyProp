...
"speed"],["set angle to (+/-)","angle"],["change position by (+/-)","goto"]],function(a){this.sourceBlock_.updateShape_(a)}),"PARAM");this.appendDummyInput().appendField("\u00b0/s","END");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},updateShape_:function(a){"speed"===a?this.setFieldValue("\u00b0/s","END"):this.setFieldValue("\u00b0","END")},onchange:Blockly.Blocks.fb360_setup.onchange,mutationToDom:function(){var a=document.createElement("mutation");
a.setAttribute("param",this.getFieldValue("PARAM"));return a},domToMutation:function(a){a=a.getAttribute("param");this.updateShape_(a)}};Blockly.propc.fb360_set=Blockly.propc.fb360_setup;
