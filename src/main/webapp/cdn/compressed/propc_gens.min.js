...
Blockly.Blocks.fb360_setup={init:function(){this.setTooltip(Blockly.MSG_FB360_SETUP_TOOLTIP);"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendDummyInput().appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField(new Blockly.FieldDropdown([["set acceleration to",
"setAcceleration"],["set max speed (+/-) to","setMaxSpeed"]],function(a){this.sourceBlock_.updateShape_(a)}),"PARAM");this.appendDummyInput("OPTION").appendField(new Blockly.FieldDropdown([["7200\u00b0/s\u00b2","2000"],["4800\u00b0/s\u00b2 (peppy)","1200"],["3600\u00b0/s\u00b2","800"],["2400\u00b0/s\u00b2 (smooth)","400"],["1200\u00b0/s\u00b2","200"],["600\u00b0/s\u00b2 (sluggish)","100"]]),"VALUE");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},updateShape_:function(a){this.removeInput("OPTION");
...
b[c].type,e=this.getFieldValue("PIN");"fb360_init"!==d||b[c].getFieldValue("PIN")!==e&&b[c].getFieldValue("FB")!==e||(a=null)}this.setWarningText(a)}};
Blockly.propc.fb360_setup=function(){var a=this.getFieldValue("PARAM");var b="fb360_setup"===this.type?this.getFieldValue("VALUE")||"0":Blockly.propc.valueToCode(this,"VALUE",Blockly.propc.ORDER_NONE)||"0";var c=this.getFieldValue("PIN");return-1<Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Feedback 360\u00b0 servo initialize")?"servo360_"+a+"("+c+", "+b+");\n":"// WARNING: You need a Feedback 360\u00b0 servo initialize block set to match the PIN on this block!"};
Blockly.Blocks.fb360_set={init:function(){this.setTooltip(Blockly.MSG_FB360_SET_TOOLTIP);"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendValueInput("VALUE").setCheck("Number").appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField(new Blockly.FieldDropdown([["set speed to (+/-)",
"speed"],["set angle to (+/-)","angle"],["change position by (+/-)","goto"]],function(a){this.sourceBlock_.updateShape_(a)}),"PARAM").appendField("R,-720,720,0","RANGEVALS0");this.getField("RANGEVALS0").setVisible(!1);this.appendDummyInput().appendField("\u00b0/s","END");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},updateShape_:function(a){"speed"===a?(this.setFieldValue("\u00b0/s","END"),this.setFieldValue("R,-720,720,0","RANGEVALS0")):("angle"===
a?this.setFieldValue("R,-1456,1456,0","RANGEVALS0"):this.setFieldValue("R,-2147483648,2147483647,0","RANGEVALS0"),this.setFieldValue("\u00b0","END"))},onchange:Blockly.Blocks.fb360_setup.onchange,mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("param",this.getFieldValue("PARAM"));return a},domToMutation:function(a){a=a.getAttribute("param");this.updateShape_(a)}};Blockly.propc.fb360_set=Blockly.propc.fb360_setup;
Blockly.Blocks.fb360_get={init:function(){this.setTooltip(Blockly.MSG_FB360_GET_TOOLTIP);"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendDummyInput("VALUE").appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("position (\u00b0)");
this.setOutput(!0,"Number")},onchange:Blockly.Blocks.fb360_setup.onchange};Blockly.propc.fb360_get=function(){return-1<Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Feedback 360\u00b0 servo initialize")?["servo360_getAngle("+this.getFieldValue("PIN")+")",Blockly.propc.ORDER_NONE]:["0",Blockly.propc.ORDER_NONE]};
...
Blockly.propc.ab_drive_init=function(){var a=this.getFieldValue("BOT");if(!this.disabled&&(-1<a.indexOf("360")&&(Blockly.propc.definitions_["include servo360"]='#include "servo360.h"'),Blockly.propc.definitions_["include abdrive"]='#include "'+a+'"',"servodiffdrive.h"===a)){a=Number(this.getFieldValue("LEFT"));var b=Number(this.getFieldValue("RIGHT"));Blockly.propc.setups_.servodiffdrive="drive_pins("+a+","+b+");\n"}return""};
...
Blockly.Blocks.activitybot_display_calibration={helpUrl:Blockly.MSG_ROBOT_HELPURL,init:function(){this.setTooltip(Blockly.MSG_ROBOT_ACTIVITYBOT_DISPLAY_CALIBRATION_TOOLTIP);this.setColour(colorPalette.getColor("robot"));this.appendDummyInput().appendField(new Blockly.FieldDropdown([["ActivityBot","abdrive.h"],["ActivityBot 360\u00b0","abdrive360.h"]],function(a){this.sourceBlock_.updateShape_(a,this.sourceBlock_.getFieldValue("TYPE"))}),"BOT");this.appendDummyInput("MENU").appendField("display calibration").appendField(new Blockly.FieldDropdown([["results",
"result"],["interpolation table","table"]]),"TYPE");this.setInputsInline(!0);this.updateShape_()},mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("bot",this.getFieldValue("BOT"));a.setAttribute("type",this.getFieldValue("TYPE"));return a},domToMutation:function(a){var b=a.getAttribute("bot");a=a.getAttribute("type");this.updateShape_(b,a)},updateShape_:function(a,b){void 0===a&&(a=this.getFieldValue("BOT"));void 0===b&&this.getFieldValue("TYPE");this.removeInput("MENU");
"abdrive.h"===a?this.appendDummyInput("MENU").appendField("display calibration").appendField(new Blockly.FieldDropdown([["results","result"],["interpolation table","table"]]),"TYPE"):this.appendDummyInput("MENU").appendField("display calibration results")}};
Blockly.propc.activitybot_display_calibration=function(){var a=this.getFieldValue("BOT")||"abdrive.h";Blockly.propc.definitions_.activitybot_calibrate='#include "'+a+'"';Blockly.propc.serial_terminal_=!0;return"table"===this.getFieldValue("TYPE")?"drive_displayInterpolation();\n":"drive_calibrationResults();\n"};
...
"ck_nl")},decompose:function(a){var b=Blockly.Block.obtain(a,"console_print_container");"console_print_multiple"===this.type?(b.initSvg(),b.setFieldValue(this.specDigits_?"TRUE":"FALSE","PLACES")):(b=Blockly.Block.obtain(a,"serial_print_container"),b.initSvg());for(var c=b.getInput("STACK").connection,d=0;d<this.optionList_.length;d++){var e=a.newBlock("console_print_"+this.optionList_[d]);e.initSvg();c.connect(e.previousConnection);c=e.nextConnection}return b},compose:function(a){for(var b=0,c=[],
d=[],e=[];this.getInput("PRINT"+b);)c[b]=this.getFieldValue("DIGIT"+b),d[b]=this.getFieldValue("PLACE"+b),e[b]=this.getFieldValue("DIV"+b),this.removeInput("PRINT"+b),b++;this.removeInput("NEWLINE");b=0;this.optionList_.length=0;var f=a.getInputTargetBlock("STACK");this.specDigits_=!1;"TRUE"===a.getFieldValue("PLACES")&&(this.specDigits_=!0);for(var g=a="";f;)g="Number","console_print_dec"===f.type?(this.optionList_.push("dec"),a="decimal number"):"console_print_hex"===f.type?(this.optionList_.push("hex"),
a="hexadecimal number"):"console_print_bin"===f.type?(this.optionList_.push("bin"),a="binary number"):"console_print_char"===f.type?(this.optionList_.push("char"),a="ASCII character"):"console_print_str"===f.type&&(this.optionList_.push("str"),g="String",a="text"),"console_print_float"!==f.type||this.specDigits_?"console_print_float"===f.type&&this.specDigits_?(this.optionList_.push("float"),g=this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(g).appendField("float point  divide by",
"TYPE"+b).appendField(new Blockly.FieldDropdown([["1","1"],["10","10"],["100","100"],["1000","1000"],["10,000","10000"],["100,000","100000"],["1,000,000","1000000"]]),"DIV"+b).appendField("digits").appendField(new Blockly.FieldTextInput("",function(a){return(a=a.replace(/O/ig,"0").replace(/[^0-9]*/g,""))||""}),"DIGIT"+b).appendField("places").appendField(new Blockly.FieldTextInput("",function(a){return(a=a.replace(/O/ig,"0").replace(/[^0-9]*/g,""))||""}),"PLACE"+b),this.setFieldValue(e[b]||"100",
"DIV"+b),this.setFieldValue(d[b]||"","PLACE"+b),this.setFieldValue(c[b]||"","DIGIT"+b)):!this.specDigits_||"hex"!==this.optionList_[b]&&"dec"!==this.optionList_[b]&&"bin"!==this.optionList_[b]?g=this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(g).appendField(a,"TYPE"+b):(g=this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(g).appendField(a,"TYPE"+b).appendField("digits").appendField(new Blockly.FieldTextInput("",function(a){return(a=a.replace(/O/ig,"0").replace(/[^0-9]*/g,
""))||""}),"DIGIT"+b),this.setFieldValue(c[b]||"","DIGIT"+b)):(this.optionList_.push("float"),g=this.appendValueInput("PRINT"+b).setAlign(Blockly.ALIGN_RIGHT).setCheck(g).appendField("float point  divide by","TYPE"+b).appendField(new Blockly.FieldDropdown([["1","1"],["10","10"],["100","100"],["1000","1000"],["10,000","10000"],["100,000","100000"],["1,000,000","1000000"]]),"DIV"+b),this.setFieldValue(e[b]||"100","DIV"+b)),f.valueConnection_&&g.connection.connect(f.valueConnection_),b++,f=f.nextConnection&&
f.nextConnection.targetBlock();"console_print_multiple"===this.type&&this.appendDummyInput("NEWLINE").appendField("then a new line").appendField(new Blockly.FieldCheckbox("FALSE"),"ck_nl")},saveConnections:function(a){a=a.getInputTargetBlock("STACK");for(var b=0;a;){var c=this.getInput("PRINT"+b);a.valueConnection_=c&&c.connection.targetConnection;a=a.nextConnection&&a.nextConnection.targetBlock();b++}},onchange:function(){var a=null;this.workspace&&1>this.optionList_.length&&(a="Terminal print multiple must have at least one term.");
this.setWarningText(a)}};Blockly.Blocks.console_print_container={init:function(){this.setColour(colorPalette.getColor("protocols"));this.appendDummyInput().appendField("send");this.appendStatementInput("STACK");this.appendDummyInput().appendField("specify digits").appendField(new Blockly.FieldCheckbox("FALSE"),"PLACES");this.contextMenu=!1}};
...
Blockly.propc.console_print_multiple=function(){Blockly.propc.serial_terminal_=!0;for(var a='print("',b="",c="",d=0;this.getInput("PRINT"+d);){var e=this.getFieldValue("DIGIT"+d);this.getFieldValue("PLACE"+d)&&""!==this.getFieldValue("PLACE"+d)&&(e+="."+this.getFieldValue("PLACE"+d));this.getFieldValue("TYPE"+d).includes("decimal number")?(a+="%"+e+"d",c="0"):this.getFieldValue("TYPE"+d).includes("hexadecimal number")?(a+="%"+e+"x",c="0x0"):this.getFieldValue("TYPE"+d).includes("binary number")?(a+=
"%"+e+"b",c="0b0"):this.getFieldValue("TYPE"+d).includes("text")?(a+="%s",c='" "'):this.getFieldValue("TYPE"+d).includes("ASCII character")?(a+="%c",c="32"):this.getFieldValue("TYPE"+d).includes("float point  divide by")&&(a+="%"+e+"f",c="0");b=this.getFieldValue("TYPE"+d).includes("float point  divide by")?b+(", ((float) "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||c)+") / "+this.getFieldValue("DIV"+d)+".0"):b+(", "+(Blockly.propc.valueToCode(this,"PRINT"+d,Blockly.propc.NONE)||
c));d++}"TRUE"===this.getFieldValue("ck_nl")&&(a+="\\r");return a+('"'+b+");\n")};
