...
-1<b.indexOf("Robot Arlo initialize")?a="arlodrive.h":-1<b.indexOf("Robot Servo Differential Drive initialize")&&(a="servodiffdrive.h");this.newRobot(a)},newRobot:function(a){this.setWarningText(null);"abdrive.h"===a||"arlodrive.h"===a||"abdrive360.h"===a?(this.setFieldValue("Robot set acceleration for","TITLE"),this.getField("TITLE_2").setVisible(!0),this.getField("OPS").setVisible(!0),this.getField("RAMPING").setVisible(!0)):""===a?(this.setWarningText("WARNING: You must use a Robot initialize\nblock at the beginning of your program!"),
this.setFieldValue("Robot set acceleration","TITLE"),this.getField("TITLE_2").setVisible(!1),this.getField("OPS").setVisible(!1),this.getField("RAMPING").setVisible(!1)):(this.setFieldValue("Robot set acceleration to","TITLE"),this.getField("TITLE_2").setVisible(!1),this.getField("OPS").setVisible(!1),this.getField("RAMPING").setVisible(!0));this.render()}};
