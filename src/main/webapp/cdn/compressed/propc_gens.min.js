...
Blockly.Blocks.fb360_init={init:function(){"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendDummyInput().appendField("Feedback 360\u00b0 servo initialize PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("FB").appendField(new Blockly.FieldDropdown(profile["default"].digital),
...
Blockly.Blocks.fb360_setup={init:function(){"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendDummyInput().appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField(new Blockly.FieldDropdown([["set acceleration to","setAcceleration"],
["set max speed (+/-) to","setMaxSpeed"]],function(a){this.sourceBlock_.updateShape_(a)}),"PARAM");this.appendDummyInput("OPTION").appendField(new Blockly.FieldDropdown([["7200\u00b0/s\u00b2","2000"],["4800\u00b0/s\u00b2 (peppy)","1200"],["3600\u00b0/s\u00b2","800"],["2400\u00b0/s\u00b2 (smooth)","400"],["1200\u00b0/s\u00b2","200"],["600\u00b0/s\u00b2 (sluggish)","100"]]),"VALUE");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},updateShape_:function(a){this.removeInput("OPTION");
"setAcceleration"===a?this.appendDummyInput("OPTION").appendField(new Blockly.FieldDropdown([["7200\u00b0/s\u00b2","2000"],["4800\u00b0/s\u00b2 (peppy)","1200"],["3600\u00b0/s\u00b2","800"],["2400\u00b0/s\u00b2 (smooth)","400"],["1200\u00b0/s\u00b2","200"],["600\u00b0/s\u00b2 (sluggish)","100"]]),"VALUE"):this.appendDummyInput("OPTION").appendField(new Blockly.FieldTextInput("1080",function(a){a=Blockly.FieldTextInput.numberValidator(a);1>a&&(a=1);1080<a&&(a=1080);return a}),"VALUE").appendField("\u00b0/s")},
mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("param",this.getFieldValue("PARAM"));a.setAttribute("value",this.getFieldValue("VALUE"));return a},domToMutation:function(a){var b=a.getAttribute("param");a=a.getAttribute("value");this.updateShape_(b);this.setFieldValue(a,"VALUE")},onchange:function(){for(var a="WARNING: You need a Feedback 360\u00b0 servo initialize block set to match the PIN on this block!",b=Blockly.getMainWorkspace().getAllBlocks(),c=0;c<b.length;c++){var d=
b[c].type,e=this.getFieldValue("PIN");"fb360_init"!==d||b[c].getFieldValue("PIN")!==e&&b[c].getFieldValue("FB")!==e||(a=null)}this.setWarningText(a)}};Blockly.propc.fb360_setup=function(){var a=this.getFieldValue("PARAM"),b=this.getFieldValue("VALUE")||"0",c=this.getFieldValue("PIN");return-1<Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Feedback 360\u00b0 servo initialize")?"servo360_"+a+"("+c+", "+b+");\n":"// WARNING: You need a Feedback 360\u00b0 servo initialize block set to match the PIN on this block!"};
Blockly.Blocks.fb360_set={init:function(){"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendValueInput("VALUE").setCheck("Number").appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField(new Blockly.FieldDropdown([["set speed to (+/-)",
"speed"],["change position by (+/-)","goto"]],function(a){this.sourceBlock_.updateShape_(a)}),"PARAM");this.appendDummyInput().appendField("\u00b0/s","END");this.setInputsInline(!0);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)},updateShape_:function(a){"speed"===a?this.setFieldValue("\u00b0/s","END"):this.setFieldValue("\u00b0","END")},onchange:Blockly.Blocks.fb360_setup.onchange,mutationToDom:function(){var a=document.createElement("mutation");a.setAttribute("param",this.getFieldValue("PARAM"));
return a},domToMutation:function(a){a=a.getAttribute("param");this.updateShape_(a)}};Blockly.propc.fb360_set=Blockly.propc.fb360_setup;
Blockly.Blocks.fb360_get={init:function(){"Scribbler Robot"===profile["default"].description?(this.setHelpUrl(Blockly.MSG_S3_SERVO_HELPURL),this.setColour(colorPalette.getColor("robot"))):(this.setHelpUrl(Blockly.MSG_SERVO_HELPURL),this.setColour(colorPalette.getColor("output")));this.appendDummyInput("VALUE").appendField("Feedback 360\u00b0 servo PIN").appendField(new Blockly.FieldDropdown(profile["default"].digital),"PIN").appendField("position (\u00b0)");this.setOutput(!0,"Number")},onchange:Blockly.Blocks.fb360_setup.onchange};
Blockly.propc.fb360_get=function(){return-1<Blockly.getMainWorkspace().getAllBlocks().toString().indexOf("Feedback 360\u00b0 servo initialize")?["servo360_get("+this.getFieldValue("PIN")+")",Blockly.propc.ORDER_NONE]:["0",Blockly.propc.ORDER_NONE]};
...
this.appendDummyInput("ACCEL").appendField("Robot set acceleration")):(this.appendDummyInput("ACCEL").appendField("Robot set acceleration to").appendField(new Blockly.FieldDropdown(d),"RAMPING"),this.setFieldValue(c||"600","RAMPING"))}};
...
this.setInputsInline(!1);this.setPreviousStatement(!0,"Block");this.setNextStatement(!0,null)}};Blockly.propc.scribbler_stop_servo=function(){for(var a=this.getFieldValue("SERVO_PIN"),b="",c=Blockly.getMainWorkspace().getAllBlocks(),d=0;d<c.length;d++)"fb360_init"!==c[d].type||c[d].getFieldValue("PIN")!==a&&c[d].getFieldValue("FB")!==a||(b="360");""===b&&(Blockly.propc.definitions_["include servo"]='#include "servo.h"');return"servo"+b+"_disable("+a+");\n"};
