...
xmlToolbox += '            <block type="string_var_length" experimental="true"></block>';
...
xmlToolbox += '            <block type="find_substring_zero"></block>';
...
xmlToolbox += '            <block type="string_scan_multiple" experimental="true"></block>';
xmlToolbox += '        </category>';
xmlToolbox += '    </category>';
xmlToolbox += '    <sep></sep>';
