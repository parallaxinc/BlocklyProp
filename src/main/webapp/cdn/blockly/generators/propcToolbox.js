...
xmlToolbox += '        </block>';
xmlToolbox += '    </category>';
xmlToolbox += '    <sep include="heb,"></sep>';
...
xmlToolbox += '        </category>';
xmlToolbox += '    </category>';
xmlToolbox += '    <category key="category_audio" include="heb,heb-wx," colour="295">';
...
xmlToolbox += '        </category>';
xmlToolbox += '    </category>';
xmlToolbox += '    <category key="category_hackable-electronic-badge_led_control" include="heb,heb-wx," colour="225">';
...
xmlToolbox += '        </block>';
xmlToolbox += '    </category>';
xmlToolbox += '    <category key="category_sensor-input" include="heb,heb-wx," colour="185">';
...
xmlToolbox += '        </category>';
xmlToolbox += '    </category>';
xmlToolbox += '    <category key="category_memory" include="heb,heb-wx," colour="140">';
xmlToolbox += '            <category name="Contacts">';
...
xmlToolbox += '        </category>';
xmlToolbox += '    </category>';
xmlToolbox += '    <category key="category_audio" exclude="s3,heb," colour="185">';
xmlToolbox += '        <category key="category_audio_freqout">';
...
xmlToolbox += '        </category>';
xmlToolbox += '    </category>';
xmlToolbox += '    <category key="category_servo" exclude="s3,heb," colour="165">';
